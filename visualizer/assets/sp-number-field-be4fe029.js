import{t as v,I as x,s as g,y as p,i as b,T as w,L as y,a as h,$ as m,b as f,c as I,l as U,d as q,e as k,f as a}from"./stvt-587fd650.js";const C=()=>v`<svg
  ...
  >
    ...
    />
  </svg>`;class F extends x{render(){return g(p),C()}}customElements.define("sp-icon-chevron75",F);const D=b`
...
`,P=z;var E=Object.defineProperty,N=Object.getOwnPropertyDescriptor,d=(u,t,e,r)=>{for(var o=r>1?void 0:r?N(t,e):t,i=u.length-1,n;i>=0;i--)(n=u[i])&&(o=(r?n(t,e,o):n(o))||o);return r&&o&&E(t,e,o),o};const L=5,l="-",V={"１":"1","２":"2","３":"3","４":"4","５":"5","６":"6","７":"7","８":"8","９":"9","０":"0","、":",","，":",","。":".","．":".","％":"%","＋":"+",ー:"-"};class s extends w{constructor(){super(...arguments),this.focused=!1,this._forcedUnit="",this.formatOptions={},this.hideStepper=!1,this.indeterminate=!1,this.keyboardFocused=!1,this.managedInput=!1,this.stepModifier=10,this._value=NaN,this._trackingValue="",this.changeCount=0,this.languageResolver=new y(this),this.wasIndeterminate=!1}static get styles(){return[...super.styles,P,_]}set value(t){const e=this.validateInput(t);if(e===this.value)return;const r=this._value;this._value=e,this.requestUpdate("value",r)}get value(){return this._value}get inputValue(){return this.indeterminate?this.formattedValue:this.inputElement.value}get valueAsString(){return this._value.toString()}set valueAsString(t){this.value=this.numberParser.parse(t)}get formattedValue(){return isNaN(this.value)?"":this.numberFormatter.format(this.value)+(this.focused?"":this._forcedUnit)}convertValueToNumber(t){var e;if(h()&&this.inputElement.inputMode==="decimal"){const r=this.numberFormatter.formatToParts(1000.1),o=t.split("").find(n=>n===","||n==="."),i=(e=r.find(n=>n.type==="decimal"))==null?void 0:e.value;o&&i&&(t=t.replace(o,i))}return this.numberParser.parse(t)}get _step(){var t;return typeof this.step<"u"?this.step:((t=this.formatOptions)==null?void 0:t.style)==="percent"?.01:1}handlePointerdown(t){if(t.button!==0){t.preventDefault();return}this.managedInput=!0,this.buttons.setPointerCapture(t.pointerId);const e=this.buttons.children[0].getBoundingClientRect(),r=this.buttons.children[1].getBoundingClientRect();this.findChange=o=>{o.clientX>=e.x&&o.clientY>=e.y&&o.clientX<=e.x+e.width&&o.clientY<=e.y+e.height?this.change=i=>this.increment(i.shiftKey?this.stepModifier:1):o.clientX>=r.x&&o.clientY>=r.y&&o.clientX<=r.x+r.width&&o.clientY<=r.y+r.height&&(this.change=i=>this.decrement(i.shiftKey?this.stepModifier:1))},this.findChange(t),this.startChange(t)}startChange(t){this.changeCount=0,this.doChange(t),this.safty=setTimeout(()=>{this.doNextChange(t)},400)}doChange(t){this.change(t)}handlePointermove(t){this.findChange(t)}handlePointerup(t){this.buttons.releasePointerCapture(t.pointerId),cancelAnimationFrame(this.nextChange),clearTimeout(this.safty),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.managedInput=!1}doNextChange(t){return this.changeCount+=1,this.changeCount%L===0&&this.doChange(t),requestAnimationFrame(()=>{this.nextChange=this.doNextChange(t)})}stepBy(t){if(this.disabled||this.readonly)return;const e=typeof this.min<"u"?this.min:0;let r=this.value;r+=t*this._step,isNaN(this.value)?this.value=e:this.value=r,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.indeterminate=!1,this.focus()}increment(t=1){this.stepBy(1*t)}decrement(t=1){this.stepBy(-1*t)}handleKeydown(t){switch(t.code){case"ArrowUp":t.preventDefault(),this.increment(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));break;case"ArrowDown":t.preventDefault(),this.decrement(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));break}}onScroll(t){t.preventDefault(),this.managedInput=!0;const e=t.shiftKey?t.deltaX/Math.abs(t.deltaX):t.deltaY/Math.abs(t.deltaY);e!==0&&!isNaN(e)&&this.stepBy(e*(t.shiftKey?this.stepModifier:1)),this.managedInput=!1}onFocus(){super.onFocus(),this._trackingValue=this.inputValue,this.keyboardFocused=!this.readonly&&!0,this.addEventListener("wheel",this.onScroll,{passive:!1})}onBlur(){super.onBlur(),this.keyboardFocused=!this.readonly&&!1,this.removeEventListener("wheel",this.onScroll)}handleFocusin(){this.focused=!this.readonly&&!0,this.keyboardFocused=!this.readonly&&!0}handleFocusout(){this.focused=!this.readonly&&!1,this.keyboardFocused=!this.readonly&&!1}handleChange(){const t=this.convertValueToNumber(this.inputValue);if(this.wasIndeterminate&&(this.wasIndeterminate=!1,this.indeterminateValue=void 0,isNaN(t))){this.indeterminate=!0;return}this.value=t,super.handleChange()}handleInput(){this.indeterminate&&(this.wasIndeterminate=!0,this.indeterminateValue=this.value,this.inputElement.value=this.inputElement.value.replace(l,""));const{value:t,selectionStart:e}=this.inputElement,r=t.split("").map(c=>V[c]||c).join("");if(this.numberParser.isValidPartialNumber(r)){const c=this.convertValueToNumber(r);!r&&this.indeterminateValue?(this.indeterminate=!0,this._value=this.indeterminateValue):(this.indeterminate=!1,this._value=this.validateInput(c)),this._trackingValue=r,this.inputElement.value=r;return}const o=r.length,i=this._trackingValue.length,n=(e||o)-(o-i);this.inputElement.value=this.indeterminate?l:this._trackingValue,this.inputElement.setSelectionRange(n,n)}validateInput(t){if(typeof this.min<"u"&&(t=Math.max(this.min,t)),typeof this.max<"u"&&(t=Math.min(this.max,t)),this.step){const e=typeof this.min<"u"?this.min:0,r=(t-e)%this.step;if(r===0||(Math.round(r/this.step)===1?t+=this.step-r:t-=r),typeof this.max<"u")for(;t>this.max;)t-=this.step}return t}get displayValue(){const t=this.focused?"":l;return this.indeterminate?t:this.formattedValue}clearNumberFormatterCache(){this._numberFormatter=void 0,this._numberParser=void 0}get numberFormatter(){if(!this._numberFormatter||!this._numberFormatterFocused){const{style:t,unit:e,unitDisplay:r,...o}=this.formatOptions;t!=="unit"&&(o.style=t),this._numberFormatterFocused=new m(this.languageResolver.language,o);try{this._numberFormatter=new m(this.languageResolver.language,this.formatOptions),this._forcedUnit="",this._numberFormatter.format(1)}catch{t==="unit"&&(this._forcedUnit=e),this._numberFormatter=this._numberFormatterFocused}}return this.focused?this._numberFormatterFocused:this._numberFormatter}get numberParser(){if(!this._numberParser||!this._numberParserFocused){const{style:t,unit:e,unitDisplay:r,...o}=this.formatOptions;t!=="unit"&&(o.style=t),this._numberParserFocused=new f(this.languageResolver.language,o);try{this._numberParser=new f(this.languageResolver.language,this.formatOptions),this._forcedUnit="",this._numberParser.parse("0")}catch{t==="unit"&&(this._forcedUnit=e),this._numberParser=this._numberParserFocused}}return this.focused?this._numberParserFocused:this._numberParser}renderField(){return this.autocomplete="off",p`
            ${super.renderField()}
            ${this.hideStepper?p``:p`
                      <span
                          class="buttons"
                          @focusin=${this.handleFocusin}
                          @focusout=${this.handleFocusout}
                          ${I({start:["pointerdown",this.handlePointerdown],streamInside:[["pointermove","pointerenter","pointerleave","pointerover","pointerout"],this.handlePointermove],end:[["pointerup","pointercancel"],this.handlePointerup]})}
                      >
                          <sp-action-button
                              class="stepUp"
                              label="Increment"
                  ...
                  `}
        `}update(t){if((t.has("formatOptions")||t.has("resolvedLanguage"))&&this.clearNumberFormatterCache(),t.has("value")||t.has("max")||t.has("min")){const e=this.numberParser.parse(this.formattedValue.replace(this._forcedUnit,""));this.value=e}super.update(t)}willUpdate(t){this.multiline=!1,t.has(U)&&this.clearNumberFormatterCache()}firstUpdated(t){super.firstUpdated(t),this.addEventListener("keydown",this.handleKeydown)}updated(t){if(t.has("min")||t.has("formatOptions")){let e="numeric";const r=typeof this.min<"u"&&this.min<0,{maximumFractionDigits:o}=this.numberFormatter.resolvedOptions(),i=o>0;h()?r?e="text":i&&(e="decimal"):q()&&(r?e="numeric":i&&(e="decimal")),this.inputElement.inputMode=e}}}d([k(".buttons")],s.prototype,"buttons",2),d([a({type:Boolean,reflect:!0})],s.prototype,"focused",2),d([a({type:Object,attribute:"format-options"})],s.prototype,"formatOptions",2),d([a({type:Boolean,reflect:!0,attribute:"hide-stepper"})],s.prototype,"hideStepper",2),d([a({type:Boolean,reflect:!0})],s.prototype,"indeterminate",2),d([a({type:Boolean,reflect:!0,attribute:"keyboard-focused"})],s.prototype,"keyboardFocused",2),d([a({type:Number})],s.prototype,"max",2),d([a({type:Number})],s.prototype,"min",2),d([a({type:Number})],s.prototype,"step",2),d([a({type:Number,reflect:!0,attribute:"step-modifier"})],s.prototype,"stepModifier",2),d([a({type:Number})],s.prototype,"value",1);customElements.define("sp-number-field",s);
