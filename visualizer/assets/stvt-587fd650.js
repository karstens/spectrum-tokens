(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function e(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerpolicy&&(s.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?s.credentials="include":o.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=e(o);fetch(o.href,s)}})();const ee=window,de=ee.ShadowRoot&&(ee.ShadyCSS===void 0||ee.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Xe=Symbol(),nr=new WeakMap;let Fr=class{constructor(t,e,r){if(this._$cssResult$=!0,r!==Xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(de&&t===void 0){const r=e!==void 0&&e.length===1;r&&(t=nr.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),r&&nr.set(e,t))}return t}toString(){return this.cssText}};const $o=a=>new Fr(typeof a=="string"?a:a+"",void 0,Xe),v=(a,...t)=>{const e=a.length===1?a[0]:t.reduce((r,o,s)=>r+(i=>{if(i._$cssResult$===!0)return i.cssText;if(typeof i=="number")return i;throw Error("Value passed to 'css' function must be a 'css' function result: "+i+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[s+1],a[0]);return new Fr(e,a,Xe)},Co=(a,t)=>{de?a.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):t.forEach(e=>{const r=document.createElement("style"),o=ee.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=e.cssText,a.appendChild(r)})},ur=de?a=>a:a=>a instanceof CSSStyleSheet?(t=>{let e="";for(const r of t.cssRules)e+=r.cssText;return $o(e)})(a):a;var fe;const ce=window,dr=ce.trustedTypes,So=dr?dr.emptyScript:"",pr=ce.reactiveElementPolyfillSupport,je={toAttribute(a,t){switch(t){case Boolean:a=a?So:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,t){let e=a;switch(t){case Boolean:e=a!==null;break;case Number:e=a===null?null:Number(a);break;case Object:case Array:try{e=JSON.parse(a)}catch{e=null}}return e}},Mr=(a,t)=>t!==a&&(t==t||a==a),ye={attribute:!0,type:String,converter:je,reflect:!1,hasChanged:Mr};let wt=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(t){var e;this.finalize(),((e=this.h)!==null&&e!==void 0?e:this.h=[]).push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach((e,r)=>{const o=this._$Ep(r,e);o!==void 0&&(this._$Ev.set(o,r),t.push(o))}),t}static createProperty(t,e=ye){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const r=typeof t=="symbol"?Symbol():"__"+t,o=this.getPropertyDescriptor(t,r,e);o!==void 0&&Object.defineProperty(this.prototype,t,o)}}static getPropertyDescriptor(t,e,r){return{get(){return this[e]},set(o){const s=this[t];this[e]=o,this.requestUpdate(t,s,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||ye}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),t.h!==void 0&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const e=this.properties,r=[...Object.getOwnPropertyNames(e),...Object.getOwnPropertySymbols(e)];for(const o of r)this.createProperty(o,e[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const r=new Set(t.flat(1/0).reverse());for(const o of r)e.unshift(ur(o))}else t!==void 0&&e.push(ur(t));return e}static _$Ep(t,e){const r=e.attribute;return r===!1?void 0:typeof r=="string"?r:typeof t=="string"?t.toLowerCase():void 0}u(){var t;this._$E_=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(t=this.constructor.h)===null||t===void 0||t.forEach(e=>e(this))}addController(t){var e,r;((e=this._$ES)!==null&&e!==void 0?e:this._$ES=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((r=t.hostConnected)===null||r===void 0||r.call(t))}removeController(t){var e;(e=this._$ES)===null||e===void 0||e.splice(this._$ES.indexOf(t)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((t,e)=>{this.hasOwnProperty(e)&&(this._$Ei.set(e,this[e]),delete this[e])})}createRenderRoot(){var t;const e=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return Co(e,this.constructor.elementStyles),e}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$ES)===null||t===void 0||t.forEach(e=>{var r;return(r=e.hostConnected)===null||r===void 0?void 0:r.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$ES)===null||t===void 0||t.forEach(e=>{var r;return(r=e.hostDisconnected)===null||r===void 0?void 0:r.call(e)})}attributeChangedCallback(t,e,r){this._$AK(t,r)}_$EO(t,e,r=ye){var o;const s=this.constructor._$Ep(t,r);if(s!==void 0&&r.reflect===!0){const i=(((o=r.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?r.converter:je).toAttribute(e,r.type);this._$El=t,i==null?this.removeAttribute(s):this.setAttribute(s,i),this._$El=null}}_$AK(t,e){var r;const o=this.constructor,s=o._$Ev.get(t);if(s!==void 0&&this._$El!==s){const i=o.getPropertyOptions(s),c=typeof i.converter=="function"?{fromAttribute:i.converter}:((r=i.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?i.converter:je;this._$El=s,this[s]=c.fromAttribute(e,i.type),this._$El=null}}requestUpdate(t,e,r){let o=!0;t!==void 0&&(((r=r||this.constructor.getPropertyOptions(t)).hasChanged||Mr)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),r.reflect===!0&&this._$El!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,r))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,s)=>this[s]=o),this._$Ei=void 0);let e=!1;const r=this._$AL;try{e=this.shouldUpdate(r),e?(this.willUpdate(r),(t=this._$ES)===null||t===void 0||t.forEach(o=>{var s;return(s=o.hostUpdate)===null||s===void 0?void 0:s.call(o)}),this.update(r)):this._$Ek()}catch(o){throw e=!1,this._$Ek(),o}e&&this._$AE(r)}willUpdate(t){}_$AE(t){var e;(e=this._$ES)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdated)===null||o===void 0?void 0:o.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((e,r)=>this._$EO(r,this[r],e)),this._$EC=void 0),this._$Ek()}updated(t){}firstUpdated(t){}};wt.finalized=!0,wt.elementProperties=new Map,wt.elementStyles=[],wt.shadowRootOptions={mode:"open"},pr==null||pr({ReactiveElement:wt}),((fe=ce.reactiveElementVersions)!==null&&fe!==void 0?fe:ce.reactiveElementVersions=[]).push("1.4.2");var ke;const le=window,Ct=le.trustedTypes,mr=Ct?Ct.createPolicy("lit-html",{createHTML:a=>a}):void 0,X=`lit$${(Math.random()+"").slice(9)}$`,We="?"+X,_o=`<${We}>`,St=document,Ut=(a="")=>St.createComment(a),Rt=a=>a===null||typeof a!="object"&&typeof a!="function",Dr=Array.isArray,qr=a=>Dr(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",Nt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,br=/-->/g,hr=/>/g,lt=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),gr=/'/g,vr=/"/g,Br=/^(?:script|style|textarea|title)$/i,Hr=a=>(t,...e)=>({_$litType$:a,strings:t,values:e}),d=Hr(1),fr=Hr(2),M=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),yr=new WeakMap,$t=St.createTreeWalker(St,129,null,!1),Ur=(a,t)=>{const e=a.length-1,r=[];let o,s=t===2?"<svg>":"",i=Nt;for(let n=0;n<e;n++){const u=a[n];let m,b,p=-1,h=0;for(;h<u.length&&(i.lastIndex=h,b=i.exec(u),b!==null);)h=i.lastIndex,i===Nt?b[1]==="!--"?i=br:b[1]!==void 0?i=hr:b[2]!==void 0?(Br.test(b[2])&&(o=RegExp("</"+b[2],"g")),i=lt):b[3]!==void 0&&(i=lt):i===lt?b[0]===">"?(i=o??Nt,p=-1):b[1]===void 0?p=-2:(p=i.lastIndex-b[2].length,m=b[1],i=b[3]===void 0?lt:b[3]==='"'?vr:gr):i===vr||i===gr?i=lt:i===br||i===hr?i=Nt:(i=lt,o=void 0);const g=i===lt&&a[n+1].startsWith("/>")?" ":"";s+=i===Nt?u+_o:p>=0?(r.push(m),u.slice(0,p)+"$lit$"+u.slice(p)+X+g):u+X+(p===-2?(r.push(void 0),n):g)}const c=s+(a[e]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return[mr!==void 0?mr.createHTML(c):c,r]};class Gt{constructor({strings:t,_$litType$:e},r){let o;this.parts=[];let s=0,i=0;const c=t.length-1,n=this.parts,[u,m]=Ur(t,e);if(this.el=Gt.createElement(u,r),$t.currentNode=this.el.content,e===2){const b=this.el.content,p=b.firstChild;p.remove(),b.append(...p.childNodes)}for(;(o=$t.nextNode())!==null&&n.length<c;){if(o.nodeType===1){if(o.hasAttributes()){const b=[];for(const p of o.getAttributeNames())if(p.endsWith("$lit$")||p.startsWith(X)){const h=m[i++];if(b.push(p),h!==void 0){const g=o.getAttribute(h.toLowerCase()+"$lit$").split(X),f=/([.?@])?(.*)/.exec(h);n.push({type:1,index:s,name:f[2],strings:g,ctor:f[1]==="."?Gr:f[1]==="?"?Kr:f[1]==="@"?Vr:Kt})}else n.push({type:6,index:s})}for(const p of b)o.removeAttribute(p)}if(Br.test(o.tagName)){const b=o.textContent.split(X),p=b.length-1;if(p>0){o.textContent=Ct?Ct.emptyScript:"";for(let h=0;h<p;h++)o.append(b[h],Ut()),$t.nextNode(),n.push({type:2,index:++s});o.append(b[p],Ut())}}}else if(o.nodeType===8)if(o.data===We)n.push({type:2,index:s});else{let b=-1;for(;(b=o.data.indexOf(X,b+1))!==-1;)n.push({type:7,index:s}),b+=X.length-1}s++}}static createElement(t,e){const r=St.createElement("template");return r.innerHTML=t,r}}function ut(a,t,e=a,r){var o,s,i,c;if(t===M)return t;let n=r!==void 0?(o=e._$Co)===null||o===void 0?void 0:o[r]:e._$Cl;const u=Rt(t)?void 0:t._$litDirective$;return(n==null?void 0:n.constructor)!==u&&((s=n==null?void 0:n._$AO)===null||s===void 0||s.call(n,!1),u===void 0?n=void 0:(n=new u(a),n._$AT(a,e,r)),r!==void 0?((i=(c=e)._$Co)!==null&&i!==void 0?i:c._$Co=[])[r]=n:e._$Cl=n),n!==void 0&&(t=ut(a,n._$AS(a,t.values),n,r)),t}class Rr{constructor(t,e){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var e;const{el:{content:r},parts:o}=this._$AD,s=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:St).importNode(r,!0);$t.currentNode=s;let i=$t.nextNode(),c=0,n=0,u=o[0];for(;u!==void 0;){if(c===u.index){let m;u.type===2?m=new Et(i,i.nextSibling,this,t):u.type===1?m=new u.ctor(i,u.name,u.strings,this,t):u.type===6&&(m=new Yr(i,this,t)),this.u.push(m),u=o[++n]}c!==(u==null?void 0:u.index)&&(i=$t.nextNode(),c++)}return s}p(t){let e=0;for(const r of this.u)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}}class Et{constructor(t,e,r,o){var s;this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=o,this._$Cm=(s=o==null?void 0:o.isConnected)===null||s===void 0||s}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=ut(this,t,e),Rt(t)?t===z||t==null||t===""?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==M&&this.g(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):qr(t)?this.k(t):this.g(t)}O(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==z&&Rt(this._$AH)?this._$AA.nextSibling.data=t:this.T(St.createTextNode(t)),this._$AH=t}$(t){var e;const{values:r,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Gt.createElement(o.h,this.options)),o);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===s)this._$AH.p(r);else{const i=new Rr(s,this),c=i.v(this.options);i.p(r),this.T(c),this._$AH=i}}_$AC(t){let e=yr.get(t.strings);return e===void 0&&yr.set(t.strings,e=new Gt(t)),e}k(t){Dr(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let r,o=0;for(const s of t)o===e.length?e.push(r=new Et(this.O(Ut()),this.O(Ut()),this,this.options)):r=e[o],r._$AI(s),o++;o<e.length&&(this._$AR(r&&r._$AB.nextSibling,o),e.length=o)}_$AR(t=this._$AA.nextSibling,e){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,e);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var e;this._$AM===void 0&&(this._$Cm=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}let Kt=class{constructor(t,e,r,o,s){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=o,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=z}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,r,o){const s=this.strings;let i=!1;if(s===void 0)t=ut(this,t,e,0),i=!Rt(t)||t!==this._$AH&&t!==M,i&&(this._$AH=t);else{const c=t;let n,u;for(t=s[0],n=0;n<s.length-1;n++)u=ut(this,c[r+n],e,n),u===M&&(u=this._$AH[n]),i||(i=!Rt(u)||u!==this._$AH[n]),u===z?t=z:t!==z&&(t+=(u??"")+s[n+1]),this._$AH[n]=u}i&&!o&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};class Gr extends Kt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}}const Eo=Ct?Ct.emptyScript:"";class Kr extends Kt{constructor(){super(...arguments),this.type=4}j(t){t&&t!==z?this.element.setAttribute(this.name,Eo):this.element.removeAttribute(this.name)}}class Vr extends Kt{constructor(t,e,r,o,s){super(t,e,r,o,s),this.type=5}_$AI(t,e=this){var r;if((t=(r=ut(this,t,e,0))!==null&&r!==void 0?r:z)===M)return;const o=this._$AH,s=t===z&&o!==z||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,i=t!==z&&(o===z||s);s&&this.element.removeEventListener(this.name,this,o),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,r;typeof this._$AH=="function"?this._$AH.call((r=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&r!==void 0?r:this.element,t):this._$AH.handleEvent(t)}}let Yr=class{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){ut(this,t)}};const Ao={P:"$lit$",A:X,M:We,C:1,L:Ur,R:Rr,D:qr,V:ut,I:Et,H:Kt,N:Kr,U:Vr,B:Gr,F:Yr},kr=le.litHtmlPolyfillSupport;kr==null||kr(Gt,Et),((ke=le.litHtmlVersions)!==null&&ke!==void 0?ke:le.litHtmlVersions=[]).push("2.4.0");const To=(a,t,e)=>{var r,o;const s=(r=e==null?void 0:e.renderBefore)!==null&&r!==void 0?r:t;let i=s._$litPart$;if(i===void 0){const c=(o=e==null?void 0:e.renderBefore)!==null&&o!==void 0?o:null;s._$litPart$=i=new Et(t.insertBefore(Ut(),c),c,void 0,e??{})}return i._$AI(a),i};var xe,we;let j=class extends wt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const r=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=r.firstChild),r}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=To(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return M}};j.finalized=!0,j._$litElement$=!0,(xe=globalThis.litElementHydrateSupport)===null||xe===void 0||xe.call(globalThis,{LitElement:j});const xr=globalThis.litElementPolyfillSupport;xr==null||xr({LitElement:j});((we=globalThis.litElementVersions)!==null&&we!==void 0?we:globalThis.litElementVersions=[]).push("3.2.2");const Oo=a=>t=>typeof t=="function"?((e,r)=>(customElements.define(e,r),r))(a,t):((e,r)=>{const{kind:o,elements:s}=r;return{kind:o,elements:s,finisher(i){customElements.define(e,i)}}})(a,t);const Po=(a,t)=>t.kind==="method"&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(e){e.createProperty(t.key,a)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){typeof t.initializer=="function"&&(this[t.key]=t.initializer.call(this))},finisher(e){e.createProperty(t.key,a)}};function l(a){return(t,e)=>e!==void 0?((r,o,s)=>{o.constructor.createProperty(s,r)})(a,t,e):Po(a,t)}function Xr(a){return l({...a,state:!0})}const Ze=({finisher:a,descriptor:t})=>(e,r)=>{var o;if(r===void 0){const s=(o=e.originalKey)!==null&&o!==void 0?o:e.key,i=t!=null?{kind:"method",placement:"prototype",key:s,descriptor:t(e.key)}:{...e,key:s};return a!=null&&(i.finisher=function(c){a(c,s)}),i}{const s=e.constructor;t!==void 0&&Object.defineProperty(e,r,t(r)),a==null||a(s,r)}};function W(a,t){return Ze({descriptor:e=>{const r={get(){var o,s;return(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(a))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0};if(t){const o=typeof e=="symbol"?Symbol():"__"+e;r.get=function(){var s,i;return this[o]===void 0&&(this[o]=(i=(s=this.renderRoot)===null||s===void 0?void 0:s.querySelector(a))!==null&&i!==void 0?i:null),this[o]}}return r}})}var ze;const Io=((ze=window.HTMLSlotElement)===null||ze===void 0?void 0:ze.prototype.assignedElements)!=null?(a,t)=>a.assignedElements(t):(a,t)=>a.assignedNodes(t).filter(e=>e.nodeType===Node.ELEMENT_NODE);function No(a){const{slot:t,selector:e}=a??{};return Ze({descriptor:r=>({get(){var o;const s="slot"+(t?`[name=${t}]`:":not([name])"),i=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s),c=i!=null?Io(i,a):[];return e?c.filter(n=>n.matches(e)):c},enumerable:!0,configurable:!0})})}function jo(a,t,e){let r,o=a;return typeof a=="object"?(o=a.slot,r=a):r={flatten:t},e?No({slot:o,flatten:t,selector:e}):Ze({descriptor:s=>({get(){var i,c;const n="slot"+(o?`[name=${o}]`:":not([name])"),u=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(n);return(c=u==null?void 0:u.assignedNodes(r))!==null&&c!==void 0?c:[]},enumerable:!0,configurable:!0})})}function Lo(){return new Worker(""+new URL("graph-layout-f190626e.js",import.meta.url).href)}function Wr(){return Math.random().toString(36).substring(7)}function x(a,t,e={}){a.dispatchEvent(new CustomEvent(t,{bubbles:!0,cancelable:!0,composed:!0,detail:e}))}const Fo=(a,t)=>{let e=null;return(...o)=>{e!==null&&(clearTimeout(e),e=null),e=setTimeout(()=>a(...o),t)}},Mo=2,Do=300,qo="gesture-start",Bo="gesture-drag-move",Ho="gesture-drag-start",Uo="gesture-drag-end",Ro="gesture-click",Go="gesture-doubleclick",Ko="gesture-singleclick";class pe{constructor(t,e){this.startPoint={x:0,y:0},this.currentPoint={x:0,y:0},this.priorPoint={x:0,y:0},this.totalDistance=0,this.isDragGesture=!1,this.waitingForDoubleClick=!1,this.active=!1,this.promiseResolve=()=>{},this.id=Wr(),this.boundUpHandler=this.handlePointerUp.bind(this),this.boundMoveHandler=this.handlePointerMove.bind(this),this.boundDownHandler=this.handlePointerDown.bind(this),this.element=e,this.active=!0,this.startPoint={x:t.clientX,y:t.clientY},this.currentPoint=this.startPoint,this.priorPoint=this.startPoint,document.body.addEventListener("pointermove",this.boundMoveHandler),document.body.addEventListener("pointerup",this.boundUpHandler),document.body.addEventListener("pointerdown",this.boundDownHandler),this.emitEvent(qo,t),this.promise=new Promise(r=>{this.promiseResolve=r})}static distance(t,e){return Math.sqrt((t.x-e.x)**2+(t.y-e.y)**2)}emitEvent(t,e){const{altKey:r,ctrlKey:o,shiftKey:s,metaKey:i}=e,c={altKey:r,ctrlKey:o,shiftKey:s,metaKey:i,gestureId:this.id,deltaX:this.currentPoint.x-this.priorPoint.x,deltaY:this.currentPoint.y-this.priorPoint.y,totalDistance:this.totalDistance,totalDeltaX:this.currentPoint.x-this.startPoint.x,totalDeltaY:this.currentPoint.y-this.startPoint.y,startX:this.startPoint.x,startY:this.startPoint.y,currentX:this.currentPoint.x,currentY:this.currentPoint.y,originalEvent:e};this.element.dispatchEvent(new CustomEvent(t,{bubbles:!0,cancelable:!0,composed:!0,detail:c}))}unbind(){document.body.removeEventListener("pointermove",this.boundMoveHandler),document.body.removeEventListener("pointerup",this.boundUpHandler),document.body.removeEventListener("pointerdown",this.boundDownHandler),this.active=!1,this.promiseResolve("gesturecomplete")}handlePointerMove(t){if(t.buttons===0){this.handlePointerUp(t);return}this.priorPoint=this.currentPoint,this.currentPoint={x:t.clientX,y:t.clientY},this.totalDistance=pe.distance(this.startPoint,this.currentPoint),this.isDragGesture?this.emitEvent(Bo,t):this.totalDistance>Mo&&(this.isDragGesture=!0,this.emitEvent(Ho,t))}handlePointerDown(t){this.waitingForDoubleClick&&(this.emitEvent(Go,t),this.waitingForDoubleClick=!1,this.waitingForDoubleClickTimeout&&clearTimeout(this.waitingForDoubleClickTimeout),this.unbind())}handlePointerUp(t){this.isDragGesture?(this.emitEvent(Uo,t),this.unbind()):this.waitingForDoubleClick||(this.emitEvent(Ro,t),this.waitingForDoubleClick=!0,this.waitingForDoubleClickTimeout=setTimeout(()=>{this.emitEvent(Ko,t),this.waitingForDoubleClick=!1,this.unbind()},Do))}}async function wr(a){const t=await fetch(a);if(!t.ok)throw new Error(`HTTP error! status: ${t.status}`);return await t.json()}const Zr=":^;",Jr=":*;",re=class{constructor(){this._dirtyTopology=!0,this._state=JSON.parse(JSON.stringify(re.DEFAULT_STATE)),this._stringifiedState=""}filter(a){const t=new re,e=Object.keys(this._state.nodes),r=Object.keys(this._state.adjacencyList);return e.forEach(o=>{a(this._state.nodes[o])&&t.createNode(JSON.parse(JSON.stringify(this._state.nodes[o])))}),r.forEach(o=>{t._state.nodes[o]&&this._state.adjacencyList[o].forEach(i=>{t._state.nodes[i]&&t.createAdjacency(o,i)})}),t}dirtyState(){this._stringifiedState=""}get stringifiedState(){return this._stringifiedState||(this._dirtyTopology===!0&&(this._state.topologyKey=Wr(),this._dirtyTopology=!1),this._stringifiedState=JSON.stringify(this._state)),this._stringifiedState}orphanNodes(){let a=Object.keys(this._state.nodes);return Object.values(this._state.adjacencyList).forEach(e=>a=a.filter(r=>!e.includes(r))),a}hasNode(a){return!!this._state.nodes[a]}createNode(a){this._state.nodes[a.id]=a,this.dirtyState()}updateNode(a,t){const e=this._state.nodes[a];e&&(Object.assign(e,t),this.dirtyState())}deleteNode(a){delete this._state.nodes[a],delete this._state.adjacencyList[a];for(const t in this._state.adjacencyList){const e=this._state.adjacencyList[t].indexOf(a);e>=0&&this._state.adjacencyList[t].splice(e,1)}this._dirtyTopology=!0,this.dirtyState()}createAdjacency(a,t,e){const r=this._state.adjacencyList[a]||[];if(r.indexOf(t)===-1&&(r.push(t),this._state.adjacencyList[a]=r),e){const o=this._state.nodes[a];if(o){const s=o.adjacencyLabels||{};s[t]=e,Object.assign(o,{adjacencyLabels:s})}}this._dirtyTopology=!0,this.dirtyState()}deleteAdjacency(a,t){const e=this._state.adjacencyList[a]||[],r=e.indexOf(t);r>=0&&(e.splice(r,1),this._state.adjacencyList[a]=e),this._dirtyTopology=!0,this.dirtyState()}setSize(a,t){this._state.width=a,this._state.height=t,this.dirtyState()}reset(){this._state=JSON.parse(JSON.stringify(re.DEFAULT_STATE)),this._dirtyTopology=!0,this.dirtyState()}get state(){return JSON.parse(this.stringifiedState)}set state(a){this._state=a,this.dirtyState()}};let R=re;R.DEFAULT_STATE={width:0,height:0,topologyKey:"",nodes:{},adjacencyList:{}};const Le=class{constructor(){this._state=JSON.parse(JSON.stringify(Le.DEFAULT_STATE)),this._stringifiedState=""}dirtyState(){this._stringifiedState=""}get stringifiedState(){return this._stringifiedState||(this._stringifiedState=JSON.stringify(this._state)),this._stringifiedState}setFullscreenMode(a){this._state.fullscreenMode=a,this.dirtyState()}setIsDragging(a){this._state.isDragging=a,this.dirtyState()}setPan(a,t){this._state.panX=a,this._state.panY=t,this.dirtyState()}setZoom(a){this._state.zoom=a,this.dirtyState()}setHoverId(a){a!==this._state.hoverNodeId&&(this._state.hoverNodeId=a,this.dirtyState())}getSetFilters(){return JSON.parse(JSON.stringify(this._state.setFilters))}setSetFilters(a){this._state.setFilters=a,this.dirtyState()}getSelectedComponents(){return JSON.parse(JSON.stringify(this._state.selectedComponents))}setSelectedComponents(a){this._state.selectedComponents=a,this.dirtyState()}setSpectrumColorTheme(a){this._state.spectrumColorTheme=a,this.dirtyState()}getSelectedTokens(){return JSON.parse(JSON.stringify(this._state.selectedTokens))}setSelectedTokens(a){this._state.selectedTokens=a,this.dirtyState()}setSelectionAncestorNodes(a){this._state.selectionAncestorNodes=a,this.dirtyState()}setSelectionDescendentNodes(a){this._state.selectionDescendentNodes=a,this.dirtyState()}setSelectionDescendentIntersectNodes(a){this._state.selectionDescendentIntersectNodes=a,this.dirtyState()}setListOfComponents(a){this._state.listOfComponents=a,this.dirtyState()}setComponentDescendentNodes(a){this._state.componentDescendentNodes=a,this.dirtyState()}setHoverUpstreamNodes(a){this._state.hoverUpstreamNodes=a,this.dirtyState()}reset(){this._state=JSON.parse(JSON.stringify(Le.DEFAULT_STATE)),this.dirtyState()}get state(){return JSON.parse(this.stringifiedState)}set state(a){this._state=JSON.parse(JSON.stringify(a)),this.dirtyState()}};let _t=Le;_t.DEFAULT_STATE={panX:380,panY:130,zoom:.7,spectrumColorTheme:"darkest",isDragging:!1,fullscreenMode:!1,hoverNodeId:"",setFilters:["spectrum","light","desktop"],listOfComponents:[],selectedTokens:[],selectionAncestorNodes:[],selectionDescendentNodes:[],selectionDescendentIntersectNodes:[],componentDescendentNodes:[],selectedComponents:[],hoverUpstreamNodes:[]};const zr="https://raw.githubusercontent.com/adobe/spectrum-tokens/next-major/",Vo="manifest.json";class Yo{constructor(){this.listOfComponents=[],this.listOfOrphanTokens=[],this._completeSpectrumTokenJson={}}async getCompleteSpectrumTokenJson(){if(Object.keys(this._completeSpectrumTokenJson).length>0)return this._completeSpectrumTokenJson;const t=await wr(zr+Vo),e={};for(let r=0;r<t.length;r++){const o=await wr(zr+t[r]);Object.assign(e,o)}return e}async getAllComponentNames(){if(this.listOfComponents.length>0)return this.listOfComponents;const t=await this.getCompleteSpectrumTokenJson();return Object.keys(t).reduce((o,s)=>{const i=t[s].component;return i&&o.indexOf(i)===-1&&o.push(i),o},[])}async getFilteredGraphModel(t){const e=new R,r=await this.getCompleteSpectrumTokenJson(),o=Object.keys(r);for(let c=0;c<o.length;c++){const n=o[c],u=r[n],m=[],b=[];for(u.value&&m.push({path:[],value:u.value}),u.sets&&b.push({path:[],sets:u.sets}),u.component&&(e.hasNode(u.component)===!1&&(e.createNode({type:"component",id:u.component,x:0,y:0}),this.listOfComponents.push(u.component)),e.createAdjacency(u.component,n));b.length>0;){let h=b.pop(),g=h.sets,f=h.path;t.forEach(w=>{let S=g[w];const y=[...f,w];S&&(S.value&&m.push({path:y,value:S.value}),S.sets&&b.push({path:y,sets:S.sets}))})}e.createNode({type:"token",id:n,x:0,y:0});let p=[];m.forEach(h=>{const g=h.path;let f=h.value;if(f.charAt(0)+f.charAt(f.length-1)==="{}"){const w=f.substring(1,f.length-1),S=e._state.nodes[n],$=(S.adjacencyLabels?S.adjacencyLabels:{})[w]||"",L=$.length>0?$.split(","):[],A=[...new Set([...L,...g])];e.createAdjacency(n,w,A.join(","))}else g.length>0&&(f+=`${Zr}${g.join(",")}`),p.push(f)}),p.length>0&&e.updateNode(n,{value:p.join(Jr)})}let s=e.orphanNodes();s=s.filter(c=>e._state.nodes[c].type!=="component");const i=[];return s.forEach(c=>{const u=c.split("-")[0];i.includes(u)||(i.push(u),e.createNode({type:"orphan-category",id:`${u}-*`,x:0,y:0}))}),i.forEach(c=>{const n=`${c}-`;o.forEach(u=>{u.indexOf(n)===0&&e.createAdjacency(`${c}-*`,u)})}),e}}class Xo{constructor(){this.newGraphStateCallbacks=[],this.newDictionaryCallbacks=[],this.selectedComponent="slider",this.listOfComponents=[],this.listOfOrphanNodes=[],this.graphDataSource=new Yo,this.graphLayoutWorker=new Lo,this.graphLayoutWorker.onmessage=this.recieveNewGraphLayout.bind(this),this.completeGraphModel=new R,this.displayGraphModel=new R,this.baseDisplayGraphModel=new R,this.appState=JSON.parse(JSON.stringify(_t.DEFAULT_STATE))}getNodeType(t){const{type:e}=this.completeGraphModel._state.nodes[t];return e}getDownstreamGraphFrom(...t){const e=new R,r=[...t],o=this.completeGraphModel.state;for(;r.length>0;){const s=r.shift(),i=o.nodes[s];if(!i)continue;const c=o.adjacencyList[s]||[];r.push(...c),e._state.nodes[s]=i,c.length>0&&(e._state.adjacencyList[s]=c)}return e}getUpstreamGraphFrom(t,e=this.completeGraphModel){const r=new R,o=[...t],s=e.state;for(;o.length>0;){const i=o.shift(),c=s.nodes[i];if(c){r._state.nodes[i]=c;for(const n in s.adjacencyList)s.adjacencyList[n].indexOf(i)>=0&&(r.hasNode(n)||o.push(n),r.createAdjacency(n,i))}}return r.dirtyState(),r}getAncestorNodes(...t){const e=this.getUpstreamGraphFrom(t);return Object.keys(e._state.nodes)}getDescendentNodes(...t){const e=this.getDownstreamGraphFrom(...t);return Object.keys(e._state.nodes)}getDescendentIntersectNodes(...t){const e=t.map(o=>Object.keys(this.getDownstreamGraphFrom(o)._state.nodes));return e.length<=1?[]:e.reduce((o,s)=>o.filter(i=>s.includes(i)))}assignGraphs(t,...e){return e.forEach(r=>{Object.assign(t._state.nodes,r._state.nodes),Object.entries(r._state.adjacencyList).forEach(([o,s])=>{const i=t._state.adjacencyList[o];i?t._state.adjacencyList[o]=[...new Set([...i,...s])]:t._state.adjacencyList[o]=s})}),t.dirtyState(),t}async hydrateFromJson(){const t=this.appState.setFilters;this.completeGraphModel=await this.graphDataSource.getFilteredGraphModel(t),this.listOfComponents=await this.graphDataSource.getAllComponentNames(),this.baseDisplayGraphModel=this.completeGraphModel.filter(e=>{const r=e.type==="component",o=e.type==="orphan-category";return r||o}),this.updateDisplayGraph(),this.emitNewDictionary(),this.requestGraphLayout(this.displayGraphModel)}emitNewGraphState(){const t=this.displayGraphModel.state;this.newGraphStateCallbacks.forEach(e=>e(t,[...this.listOfComponents]))}emitNewDictionary(){const e=Object.keys(this.completeGraphModel._state.nodes).map(r=>{const o=this.completeGraphModel._state.nodes[r];return{value:r,type:o.type,metadata:o.value||""}});this.newDictionaryCallbacks.forEach(r=>r(e))}onNewGraphState(t){this.newGraphStateCallbacks.push(t)}onDictionaryAvailable(t){this.newDictionaryCallbacks.push(t)}async doSomeMutation(){this.emitNewGraphState()}updateDisplayGraph(){const e=this.appState.selectedComponents.join(",")==="ALL"?[...this.listOfComponents]:this.appState.selectedComponents,r=this.appState.selectedTokens,o=this.getDownstreamGraphFrom(...e),s=this.getUpstreamGraphFrom(r),i=this.getDownstreamGraphFrom(...r);this.displayGraphModel=this.assignGraphs(o,s,i,this.baseDisplayGraphModel)}async setAppState(t){let e=!1,r=!1;const o=this.appState.setFilters.join(","),s=t.setFilters.join(","),i=this.appState.selectedComponents.join(","),c=t.selectedComponents.join(","),n=this.appState.selectedTokens.join(","),u=t.selectedTokens.join(",");(i!==c||n!==u)&&(e=!0),o!==s&&(r=!0),this.appState=t,r?await this.hydrateFromJson():e&&(this.updateDisplayGraph(),this.requestGraphLayout(this.displayGraphModel))}recieveNewGraphLayout(t){this.displayGraphModel.state=t.data,this.emitNewGraphState()}requestGraphLayout(t){this.graphLayoutWorker.postMessage(t._state)}handleEvent(t,e){switch(t){case"node-dragmove":const r=this.appState.zoom,o=this.displayGraphModel._state.nodes[e.id],{deltaX:s,deltaY:i}=e.data;o.x=o.x+s/r,o.y=o.y+i/r,this.displayGraphModel._state.nodes[e.id]=o,this.displayGraphModel.dirtyState();break}this.emitNewGraphState()}}const Je=450,Fe=20,Me=16,Qr=2,to=3,De=.1,qe=2,$e=55,qt=250,Wo=["theme","color","scale"],Zo={theme:["spectrum","express"],color:["light","dark","darkest","wireframe"],scale:["desktop","mobile"]},Jo={theme:"Theme",color:"Color Theme",scale:"Scale"};class Qo{constructor({graphController:t,selectedComponents:e,selectedTokens:r,setFilters:o}){this.newAppStateCallbacks=[],this._priorTopologyKey="",this._priorAppState=JSON.parse(JSON.stringify(_t.DEFAULT_STATE)),this.graphController=t,this.appModel=new _t,this.initialize({selectedComponents:e,selectedTokens:r,setFilters:o})}async initialize({selectedComponents:t,selectedTokens:e,setFilters:r}){this.graphController.setAppState(this.appModel.state),this.graphController.onNewGraphState(this.handleNewGraphState.bind(this)),await this.graphController.hydrateFromJson(),this.appModel.setListOfComponents(this.graphController.listOfComponents);const s=t.join(",")==="ALL"?[...this.graphController.listOfComponents]:t;this.appModel.setSelectedComponents(s),this.appModel.setSelectedTokens(e),this.appModel.setSetFilters(r),this.emitNewAppState()}emitNewAppState(){const t=this.appModel.state;this._priorAppState=t,this.newAppStateCallbacks.forEach(e=>e(t)),this.graphController.setAppState(t)}onNewAppState(t){this.newAppStateCallbacks.push(t)}handleNewGraphState(){const t=this.appModel._state.fullscreenMode,e=this.graphController.displayGraphModel._state.topologyKey+t;if(this._priorTopologyKey===e)return;this._priorTopologyKey=e;const r=this.appModel._state.selectedTokens,o=this.appModel._state.selectedComponents,s=this.graphController.getAncestorNodes(...r),i=this.graphController.getDescendentNodes(...r,...o),c=this.graphController.getDescendentIntersectNodes(...r,...o);this.appModel.setSelectionAncestorNodes(s),this.appModel.setSelectionDescendentNodes(i),this.appModel.setSelectionDescendentIntersectNodes(c);const n=[...r,...o,...i,...s];let u,m,b,p;const h=this.appModel._state.zoom;n.forEach(y=>{const $=this.graphController.displayGraphModel._state.nodes[y];$&&(u=Math.min(u||$.x,$.x-50),m=Math.min(m||$.y,$.y-50),b=Math.max(b||$.x,$.x+50+Je),p=Math.max(p||$.y,$.y+50+Fe))});const g=u||0,f=b||0,w=m||0,S=p||0;if(n.length>=1){const y=t?0:qt,$=t?0:$e,L=window.innerWidth-y,A=window.innerHeight-$,I=f-g,k=S-w,V=1/Math.max(I*h/L,k*h/A);let D=h*V;D=Math.min(qe,Math.max(De,D));const It=I*D,it=k*D,ct=g*D-y,gt=w*D-$,ve=(L-It)/2,Wt=(A-it)/2;this.appModel.setZoom(D),this.appModel.setPan(-ct+ve,-gt+Wt)}this.emitNewAppState()}handleHoverOver(t){if(this.appModel._state.hoverNodeId===t)return;const e=this.graphController.getAncestorNodes(t),r=this.appModel._state.selectionAncestorNodes,o=this.appModel._state.selectionDescendentNodes,s=r.concat(o),i=e.filter(c=>s.includes(c));this.appModel.setHoverId(t),this.appModel.setHoverUpstreamNodes(i)}handleHoverOut(t){this.appModel._state.hoverNodeId===t&&(this.appModel.setHoverId(""),this.appModel.setHoverUpstreamNodes([]))}toggleGraphNodeSelection(t,e=!1){const r=this.graphController.completeGraphModel._state.nodes[t],o=r?r.type==="component":!1;let s=this.appModel.getSelectedComponents(),i=this.appModel.getSelectedTokens(),c=s.indexOf(t)>=0||i.indexOf(t)>=0;c?o?s.splice(s.indexOf(t),1):i.splice(i.indexOf(t),1):e?o?s.push(t):i.push(t):o?(s=t?[t]:[],i=[]):(s=[],i=t?[t]:[]);let n=[...s,...i];const u=this.graphController.getAncestorNodes(...n),m=this.graphController.getDescendentNodes(...n),b=this.graphController.getDescendentIntersectNodes(...n);c&&(this.appModel.setHoverId(""),this.appModel.setHoverUpstreamNodes([])),this.appModel.setSelectedComponents(s),this.appModel.setSelectedTokens(i),this.appModel.setSelectionAncestorNodes(u),this.appModel.setSelectionDescendentNodes(m),this.appModel.setSelectionDescendentIntersectNodes(b)}setZoomCenteredOnCanvas(t){t=Math.min(qe,Math.max(De,t));const e=t/this.appModel._state.zoom,r=qt+(window.innerWidth-qt)/2,o=$e+(window.innerHeight-$e)/2,s=this.appModel._state.panX-r,i=this.appModel._state.panY-o,c=r+s*e,n=o+i*e;this.appModel.setPan(c,n),this.appModel.setZoom(t)}handleEvent(t,e){switch(t){case"node-pointerover":this.handleHoverOver(e.id);break;case"node-pointerout":this.handleHoverOut(e.id);break;case"generic-gesture-start":case"node-dragstart":this.appModel.setIsDragging(!0);break;case"generic-gesture-end":case"node-dragend":this.appModel.setIsDragging(!1);break;case"filters-selected":this.appModel.setSetFilters(e.value);break;case"set-fullscreen-mode":this.appModel.setFullscreenMode(e.value),this.handleNewGraphState();break;case"set-zoom":this.appModel.setZoom(e.value);break;case"set-zoom-centered-on-canvas":this.setZoomCenteredOnCanvas(e.value);break;case"select-id":this.toggleGraphNodeSelection(e.id,!0);break;case"panning-input-delta":const r=this.appModel._state.panX+e.x,o=this.appModel._state.panY+e.y;this.appModel.setPan(r,o);break;case"set-panning-position":this.appModel.setPan(e.x,e.y);break;case"close-tab":this.toggleGraphNodeSelection(e.value,!0);break;case"close-all-tabs":this.toggleGraphNodeSelection("",!1);break;case"node-click":this.toggleGraphNodeSelection(e.id,!0);break;case"set-spectrum-color-theme":this.appModel.setSpectrumColorTheme(e.value);break}this.emitNewAppState()}async doSomeMutation(){this.emitNewAppState()}}var ta=Object.defineProperty,ea=Object.getOwnPropertyDescriptor,ra=(a,t,e,r)=>{for(var o=r>1?void 0:r?ea(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&ta(t,e,o),o};const Be=new Set,oa=()=>{const a=document.documentElement.dir==="rtl"?document.documentElement.dir:"ltr";Be.forEach(t=>{t.setAttribute("dir",a)})},aa=new MutationObserver(oa);aa.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const sa=a=>typeof a.startManagingContentDirection<"u"||a.tagName==="SP-THEME";function ia(a){class t extends a{constructor(){super(...arguments),this.dir="ltr"}get isLTR(){return this.dir==="ltr"}hasVisibleFocusInTree(){const r=this.getRootNode().activeElement;if(!r)return!1;try{return r.matches(":focus-visible")||r.matches(".focus-visible")}catch{return r.matches(".focus-visible")}}connectedCallback(){if(!this.hasAttribute("dir")){let r=this.assignedSlot||this.parentNode;for(;r!==document.documentElement&&!sa(r);)r=r.assignedSlot||r.parentNode||r.host;const o=this.dir;if(this.dir=r.dir==="rtl"?r.dir:this.dir||"ltr",o===this.dir&&this.setAttribute("dir",this.dir),r===document.documentElement)Be.add(this);else{const{localName:s}=r;s.search("-")>-1&&!customElements.get(s)?customElements.whenDefined(s).then(()=>{r.startManagingContentDirection(this)}):r.startManagingContentDirection(this)}this._dirParent=r}super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._dirParent&&(this._dirParent===document.documentElement?Be.delete(this):this._dirParent.stopManagingContentDirection(this),this.removeAttribute("dir"))}}return ra([l({reflect:!0})],t.prototype,"dir",2),t}class ot extends ia(j){}var ca=Object.defineProperty,la=Object.getOwnPropertyDescriptor,na=(a,t,e,r)=>{for(var o=r>1?void 0:r?la(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&ca(t,e,o),o};function dt(a,{validSizes:t=["s","m","l","xl"],noDefaultSize:e,defaultSize:r="m"}={}){class o extends a{constructor(){super(...arguments),this._size=r}get size(){return this._size||r}set size(i){const c=e?null:r,n=i&&i.toLocaleLowerCase(),u=t.includes(n)?n:c;if(u&&this.setAttribute("size",u),this._size===u)return;const m=this._size;this._size=u,this.requestUpdate("size",m)}update(i){!this.hasAttribute("size")&&!e&&this.setAttribute("size",this.size),super.update(i)}}return na([l({type:String,reflect:!0})],o.prototype,"size",1),o}const ua=["spectrum","express"],da=["medium","large","medium-express","large-express"],pa=["light","lightest","dark","darkest","light-express","lightest-express","dark-express","darkest-express"],P=class extends HTMLElement{constructor(){super(),this._dir="",this._theme="spectrum",this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const t=document.importNode(P.template.content,!0);this.shadowRoot.appendChild(t),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","theme","lang","dir"]}set dir(t){if(t===this.dir)return;this.setAttribute("dir",t),this._dir=t;const e=t==="rtl"?t:"ltr";this.trackedChildren.forEach(r=>{r.setAttribute("dir",e)})}get dir(){return this._dir}attributeChangedCallback(t,e,r){e!==r&&(t==="color"?this.color=r:t==="scale"?this.scale=r:t==="lang"&&r?(this.lang=r,this._provideContext()):t==="theme"?this.theme=r:t==="dir"&&(this.dir=r))}requestUpdate(){window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow?window.ShadyCSS.styleElement(this):this.shouldAdoptStyles()}get theme(){const t=P.themeFragmentsByKind.get("theme"),{name:e}=t&&t.get("default")||{};return this._theme||e||""}set theme(t){if(t===this._theme)return;const e=t&&ua.includes(t)?t:this.theme;e!==this._theme&&(this._theme=e,this.requestUpdate()),e?this.setAttribute("theme",e):this.removeAttribute("theme")}get color(){const t=P.themeFragmentsByKind.get("color"),{name:e}=t&&t.get("default")||{};return this._color||e||""}set color(t){if(t===this._color)return;const e=t&&pa.includes(t)?t:this.color;e!==this._color&&(this._color=e,this.requestUpdate()),e?this.setAttribute("color",e):this.removeAttribute("color")}get scale(){const t=P.themeFragmentsByKind.get("scale"),{name:e}=t&&t.get("default")||{};return this._scale||e||""}set scale(t){if(t===this._scale)return;const e=t&&da.includes(t)?t:this.scale;e!==this._scale&&(this._scale=e,this.requestUpdate()),e?this.setAttribute("scale",e):this.removeAttribute("scale")}get styles(){const t=[...P.themeFragmentsByKind.keys()],e=(r,o,s)=>{const i=s&&s!=="theme"&&this.theme==="express"?r.get(`${o}-express`):r.get(o),c=o==="spectrum"||!s||this.hasAttribute(s);if(i&&c)return i.styles};return[...t.reduce((r,o)=>{const s=P.themeFragmentsByKind.get(o);let i;if(o==="app"||o==="core")i=e(s,o);else{const{[o]:c}=this;i=e(s,c,o)}return i&&r.push(i),r},[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise(t=>{this.__resolve=t})}onQueryTheme(t){if(t.defaultPrevented)return;t.preventDefault();const{detail:e}=t;e.color=this.color||void 0,e.scale=this.scale||void 0,e.lang=this.lang||document.documentElement.lang||navigator.language,e.theme=this.theme||void 0}connectedCallback(){if(this.shouldAdoptStyles(),window.ShadyCSS!==void 0&&window.ShadyCSS.styleElement(this),P.instances.add(this),!this.hasAttribute("dir")){let t=this.assignedSlot||this.parentNode;for(;t!==document.documentElement&&!(t instanceof P);)t=t.assignedSlot||t.parentNode||t.host;this.dir=t.dir==="rtl"?t.dir:"ltr"}}disconnectedCallback(){P.instances.delete(this)}startManagingContentDirection(t){this.trackedChildren.add(t)}stopManagingContentDirection(t){this.trackedChildren.delete(t)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const t=this.styles;if(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const e=[];for(const[r,o]of P.themeFragmentsByKind)for(const[s,{styles:i}]of o){if(s==="default")continue;let c=i.cssText;P.defaultFragments.has(s)||(c=c.replace(":host",`:host([${r}='${s}'])`)),e.push(c)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e,this.localName),window.ShadyCSS.prepareTemplate(P.template,this.localName)}else if(de){const e=[];for(const r of t)e.push(r.styleSheet);this.shadowRoot.adoptedStyleSheets=e}else this.shadowRoot.querySelectorAll("style").forEach(e=>e.remove()),t.forEach(e=>{const r=document.createElement("style");r.textContent=e.cssText,this.shadowRoot.appendChild(r)})}static registerThemeFragment(t,e,r){const o=P.themeFragmentsByKind.get(e)||new Map;o.size===0&&(P.themeFragmentsByKind.set(e,o),o.set("default",{name:t,styles:r}),P.defaultFragments.add(t)),o.set(t,{name:t,styles:r}),P.instances.forEach(s=>s.shouldAdoptStyles())}_provideContext(){this._contextConsumers.forEach(([t,e])=>t(this.lang,e))}_handleContextPresence(t){const e=t.composedPath()[0];if(this._contextConsumers.has(e))return;this._contextConsumers.set(e,[t.detail.callback,()=>this._contextConsumers.delete(e)]);const[r,o]=this._contextConsumers.get(e)||[];r&&o&&r(this.lang||document.documentElement.lang||navigator.language,o)}};let tt=P;tt.themeFragmentsByKind=new Map,tt.defaultFragments=new Set(["spectrum"]),tt.instances=new Set;customElements.define("sp-theme",tt);const ma=v`
...
`,ga=ha;tt.registerThemeFragment("spectrum","theme",ga);tt.registerThemeFragment("medium","scale",ba);const va=v`
...
`,fa=va;tt.registerThemeFragment("darkest","color",fa);const ya=v`
...
`,ka=ya;tt.registerThemeFragment("light","color",ka);const C=a=>a??z;const U={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},At=a=>(...t)=>({_$litDirective$:a,values:t});let Tt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,r){this._$Ct=t,this._$AM=e,this._$Ci=r}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};const{I:xa}=Ao,eo=a=>a.strings===void 0,$r=()=>document.createComment(""),jt=(a,t,e)=>{var r;const o=a._$AA.parentNode,s=t===void 0?a._$AB:t._$AA;if(e===void 0){const i=o.insertBefore($r(),s),c=o.insertBefore($r(),s);e=new xa(i,c,a,a.options)}else{const i=e._$AB.nextSibling,c=e._$AM,n=c!==a;if(n){let u;(r=e._$AQ)===null||r===void 0||r.call(e,a),e._$AM=a,e._$AP!==void 0&&(u=a._$AU)!==c._$AU&&e._$AP(u)}if(i!==s||n){let u=e._$AA;for(;u!==i;){const m=u.nextSibling;o.insertBefore(u,s),u=m}}}return e},nt=(a,t,e=a)=>(a._$AI(t,e),a),wa={},ro=(a,t=wa)=>a._$AH=t,za=a=>a._$AH,Ce=a=>{var t;(t=a._$AP)===null||t===void 0||t.call(a,!1,!0);let e=a._$AA;const r=a._$AB.nextSibling;for(;e!==r;){const o=e.nextSibling;e.remove(),e=o}};const Cr=(a,t,e)=>{const r=new Map;for(let o=t;o<=e;o++)r.set(a[o],o);return r},He=At(class extends Tt{constructor(a){if(super(a),a.type!==U.CHILD)throw Error("repeat() can only be used in text expressions")}ht(a,t,e){let r;e===void 0?e=t:t!==void 0&&(r=t);const o=[],s=[];let i=0;for(const c of a)o[i]=r?r(c,i):i,s[i]=e(c,i),i++;return{values:s,keys:o}}render(a,t,e){return this.ht(a,t,e).values}update(a,[t,e,r]){var o;const s=za(a),{values:i,keys:c}=this.ht(t,e,r);if(!Array.isArray(s))return this.ut=c,i;const n=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],u=[];let m,b,p=0,h=s.length-1,g=0,f=i.length-1;for(;p<=h&&g<=f;)if(s[p]===null)p++;else if(s[h]===null)h--;else if(n[p]===c[g])u[g]=nt(s[p],i[g]),p++,g++;else if(n[h]===c[f])u[f]=nt(s[h],i[f]),h--,f--;else if(n[p]===c[f])u[f]=nt(s[p],i[f]),jt(a,u[f+1],s[p]),p++,f--;else if(n[h]===c[g])u[g]=nt(s[h],i[g]),jt(a,s[p],s[h]),h--,g++;else if(m===void 0&&(m=Cr(c,g,f),b=Cr(n,p,h)),m.has(n[p]))if(m.has(n[h])){const w=b.get(c[g]),S=w!==void 0?s[w]:null;if(S===null){const y=jt(a,s[p]);nt(y,i[g]),u[g]=y}else u[g]=nt(S,i[g]),jt(a,s[p],S),s[w]=null;g++}else Ce(s[h]),h--;else Ce(s[p]),p++;for(;g<=f;){const w=jt(a,u[f+1]);nt(w,i[g]),u[g++]=w}for(;p<=h;){const w=s[p++];w!==null&&Ce(w)}return this.ut=c,ro(a,u),M}});const Ue=At(class extends Tt{constructor(a){var t;if(super(a),a.type!==U.ATTRIBUTE||a.name!=="class"||((t=a.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(a){return" "+Object.keys(a).filter(t=>a[t]).join(" ")+" "}update(a,[t]){var e,r;if(this.nt===void 0){this.nt=new Set,a.strings!==void 0&&(this.st=new Set(a.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((e=this.st)===null||e===void 0)&&e.has(s))&&this.nt.add(s);return this.render(t)}const o=a.element.classList;this.nt.forEach(s=>{s in t||(o.remove(s),this.nt.delete(s))});for(const s in t){const i=!!t[s];i===this.nt.has(s)||!((r=this.st)===null||r===void 0)&&r.has(s)||(i?(o.add(s),this.nt.add(s)):(o.remove(s),this.nt.delete(s)))}return M}});const Qe=At(class extends Tt{constructor(a){var t;if(super(a),a.type!==U.ATTRIBUTE||a.name!=="style"||((t=a.strings)===null||t===void 0?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(a){return Object.keys(a).reduce((t,e)=>{const r=a[e];return r==null?t:t+`${e=e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(a,[t]){const{style:e}=a.element;if(this.vt===void 0){this.vt=new Set;for(const r in t)this.vt.add(r);return this.render(t)}this.vt.forEach(r=>{t[r]==null&&(this.vt.delete(r),r.includes("-")?e.removeProperty(r):e[r]="")});for(const r in t){const o=t[r];o!=null&&(this.vt.add(r),r.includes("-")?e.setProperty(r,o):e[r]=o)}return M}});const Bt=(a,t)=>{var e,r;const o=a._$AN;if(o===void 0)return!1;for(const s of o)(r=(e=s)._$AO)===null||r===void 0||r.call(e,t,!1),Bt(s,t);return!0},ne=a=>{let t,e;do{if((t=a._$AM)===void 0)break;e=t._$AN,e.delete(a),a=t}while((e==null?void 0:e.size)===0)},oo=a=>{for(let t;t=a._$AM;a=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(a))break;e.add(a),Sa(t)}};function $a(a){this._$AN!==void 0?(ne(this),this._$AM=a,oo(this)):this._$AM=a}function Ca(a,t=!1,e=0){const r=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(r))for(let s=e;s<r.length;s++)Bt(r[s],!1),ne(r[s]);else r!=null&&(Bt(r,!1),ne(r));else Bt(this,a)}const Sa=a=>{var t,e,r,o;a.type==U.CHILD&&((t=(r=a)._$AP)!==null&&t!==void 0||(r._$AP=Ca),(e=(o=a)._$AQ)!==null&&e!==void 0||(o._$AQ=$a))};let _a=class extends Tt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,r){super._$AT(t,e,r),oo(this),this.isConnected=t._$AU}_$AO(t,e=!0){var r,o;t!==this.isConnected&&(this.isConnected=t,t?(r=this.reconnected)===null||r===void 0||r.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),e&&(Bt(this,t),ne(this))}setValue(t){if(eo(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};const Ea=At(class extends Tt{constructor(a){if(super(a),a.type!==U.PROPERTY&&a.type!==U.ATTRIBUTE&&a.type!==U.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!eo(a))throw Error("`live` bindings can only contain a single expression")}render(a){return a}update(a,[t]){if(t===M||t===z)return t;const e=a.element,r=a.name;if(a.type===U.PROPERTY){if(t===e[r])return M}else if(a.type===U.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(r))return M}else if(a.type===U.ATTRIBUTE&&e.getAttribute(r)===t+"")return M;return ro(a),t}});var Aa=Object.defineProperty,Ta=Object.getOwnPropertyDescriptor,Lt=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ta(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Aa(t,e,o),o};function ao(a){class t extends a{renderAnchor({id:r,className:o,ariaHidden:s,labelledby:i,tabindex:c,anchorContent:n=d`<slot></slot>`}){return d`<a
                    id=${r}
                    class=${C(o)}
                    href=${C(this.href)}
                    ...
                    tabindex=${C(c)}
                    rel=${C(this.rel)}
                >${n}</a>`}}return Lt([l({reflect:!0})],t.prototype,"download",2),Lt([l()],t.prototype,"label",2),Lt([l({reflect:!0})],t.prototype,"href",2),Lt([l({reflect:!0})],t.prototype,"target",2),Lt([l({reflect:!0})],t.prototype,"rel",2),t}const Oa="modulepreload",Pa=function(a,t){return new URL(a,t).href},Sr={},tr=function(t,e,r){if(!e||e.length===0)return t();const o=document.getElementsByTagName("link");return Promise.all(e.map(s=>{if(s=Pa(s,r),s in Sr)return;Sr[s]=!0;const i=s.endsWith(".css"),c=i?'[rel="stylesheet"]':"";if(!!r)for(let m=o.length-1;m>=0;m--){const b=o[m];if(b.href===s&&(!i||b.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${s}"]${c}`))return;const u=document.createElement("link");if(u.rel=i?"stylesheet":Oa,i||(u.as="script",u.crossOrigin=""),u.href=s,document.head.appendChild(u),i)return new Promise((m,b)=>{u.addEventListener("load",m),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${s}`)))})})).then(()=>t())};let Re=!0;try{document.body.querySelector(":focus-visible")}catch{Re=!1,tr(()=>import("./focus-visible-f45633b4.js").then(t=>t.f),[],import.meta.url)}const Ia=a=>{var t;const e=s=>{if(s.shadowRoot==null||s.hasAttribute("data-js-focus-visible"))return()=>{};if(self.applyFocusVisiblePolyfill)self.applyFocusVisiblePolyfill(s.shadowRoot),s.manageAutoFocus&&s.manageAutoFocus();else{const i=()=>{self.applyFocusVisiblePolyfill&&s.shadowRoot&&self.applyFocusVisiblePolyfill(s.shadowRoot),s.manageAutoFocus&&s.manageAutoFocus()};return self.addEventListener("focus-visible-polyfill-ready",i,{once:!0}),()=>{self.removeEventListener("focus-visible-polyfill-ready",i)}}return()=>{}},r=Symbol("endPolyfillCoordination");class o extends a{constructor(){super(...arguments),this[t]=null}connectedCallback(){super.connectedCallback&&super.connectedCallback(),Re||requestAnimationFrame(()=>{this[r]==null&&(this[r]=e(this))})}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),Re||requestAnimationFrame(()=>{this[r]!=null&&(this[r](),this[r]=null)})}}return t=r,o};var Na=Object.defineProperty,ja=Object.getOwnPropertyDescriptor,Se=(a,t,e,r)=>{for(var o=r>1?void 0:r?ja(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Na(t,e,o),o};function _r(){return new Promise(a=>requestAnimationFrame(()=>a()))}class et extends Ia(ot){constructor(){super(...arguments),this.disabled=!1,this.autofocus=!1,this._tabIndex=0,this.manipulatingTabindex=!1,this._recentlyConnected=!1}get tabIndex(){if(this.focusElement===this){const e=this.hasAttribute("tabindex")?Number(this.getAttribute("tabindex")):NaN;return isNaN(e)?-1:e}const t=parseFloat(this.hasAttribute("tabindex")&&this.getAttribute("tabindex")||"0");return this.disabled||t<0?-1:this.focusElement?this.focusElement.tabIndex:t}set tabIndex(t){if(this.manipulatingTabindex){this.manipulatingTabindex=!1;return}if(this.focusElement===this){if(t!==this.tabIndex){this._tabIndex=t;const e=this.disabled?"-1":""+t;this.setAttribute("tabindex",e)}return}if(t===-1?this.addEventListener("pointerdown",this.onPointerdownManagementOfTabIndex):(this.manipulatingTabindex=!0,this.removeEventListener("pointerdown",this.onPointerdownManagementOfTabIndex)),t===-1||this.disabled){this.setAttribute("tabindex","-1"),this.removeAttribute("focusable"),t!==-1&&this.manageFocusElementTabindex(t);return}this.setAttribute("focusable",""),this.hasAttribute("tabindex")?this.removeAttribute("tabindex"):this.manipulatingTabindex=!1,this.manageFocusElementTabindex(t)}onPointerdownManagementOfTabIndex(){this.tabIndex===-1&&(this.tabIndex=0,this.focus({preventScroll:!0}))}async manageFocusElementTabindex(t){this.focusElement||await this.updateComplete,t===null?this.focusElement.removeAttribute("tabindex"):this.focusElement.tabIndex=t}get focusElement(){throw new Error("Must implement focusElement getter!")}focus(t){this.disabled||!this.focusElement||(this.focusElement!==this?this.focusElement.focus(t):HTMLElement.prototype.focus.apply(this,[t]))}blur(){const t=this.focusElement||this;t!==this?t.blur():HTMLElement.prototype.blur.apply(this)}click(){if(this.disabled)return;const t=this.focusElement||this;t!==this?t.click():HTMLElement.prototype.click.apply(this)}manageAutoFocus(){this.autofocus&&(this.dispatchEvent(new KeyboardEvent("keydown",{code:"Tab"})),this.focusElement.focus())}firstUpdated(t){super.firstUpdated(t),(!this.hasAttribute("tabindex")||this.getAttribute("tabindex")!=="-1")&&this.setAttribute("focusable","")}update(t){t.has("disabled")&&this.handleDisabledChanged(this.disabled,t.get("disabled")),super.update(t)}updated(t){super.updated(t),t.has("disabled")&&this.disabled&&this.blur()}async handleDisabledChanged(t,e){const r=()=>this.focusElement!==this&&typeof this.focusElement.disabled<"u";t?(this.manipulatingTabindex=!0,this.setAttribute("tabindex","-1"),await this.updateComplete,r()?this.focusElement.disabled=!0:this.setAttribute("aria-disabled","true")):e&&(this.manipulatingTabindex=!0,this.focusElement===this?this.setAttribute("tabindex",""+this._tabIndex):this.removeAttribute("tabindex"),await this.updateComplete,r()?this.focusElement.disabled=!1:this.removeAttribute("aria-disabled"))}async getUpdateComplete(){const t=await super.getUpdateComplete();return this._recentlyConnected&&(this._recentlyConnected=!1,await _r(),await _r()),t}connectedCallback(){super.connectedCallback(),this._recentlyConnected=!0,this.updateComplete.then(()=>{this.manageAutoFocus()})}}Se([l({type:Boolean,reflect:!0})],et.prototype,"disabled",2),Se([l({type:Boolean})],et.prototype,"autofocus",2),Se([l({type:Number})],et.prototype,"tabIndex",1);const La='button:not([tabindex="-1"]), [href]:not([tabindex="-1"]), input:not([tabindex="-1"]), select:not([tabindex="-1"]), textarea:not([tabindex="-1"]), [tabindex]:not([tabindex="-1"]), [focusable]:not([tabindex="-1"])',Fa=a=>a.querySelector(La);let er=class{constructor(t,{target:e,config:r,callback:o,skipInitial:s}){this.t=new Set,this.o=!1,this.i=!1,this.h=t,e!==null&&this.t.add(e??t),this.l=r,this.o=s??this.o,this.callback=o,window.MutationObserver?(this.u=new MutationObserver(i=>{this.handleChanges(i),this.h.requestUpdate()}),t.addController(this)):console.warn("MutationController error: browser does not support MutationObserver.")}handleChanges(t){var e;this.value=(e=this.callback)===null||e===void 0?void 0:e.call(this,t,this.u)}hostConnected(){for(const t of this.t)this.observe(t)}hostDisconnected(){this.disconnect()}async hostUpdated(){const t=this.u.takeRecords();(t.length||!this.o&&this.i)&&this.handleChanges(t),this.i=!1}observe(t){this.t.add(t),this.u.observe(t,this.l),this.i=!0,this.h.requestUpdate()}disconnect(){this.u.disconnect()}};const vt=Symbol("slotContentIsPresent");function Ma(a,t){var e;const r=Array.isArray(t)?t:[t];class o extends a{constructor(...i){super(i),this[e]=new Map,this.managePresenceObservedSlot=()=>{let c=!1;r.forEach(n=>{const u=!!this.querySelector(n),m=this[vt].get(n)||!1;c=c||m!==u,this[vt].set(n,!!this.querySelector(n))}),c&&this.updateComplete.then(()=>{this.requestUpdate()})},new er(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(r.length===1)return this[vt].get(r[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(i){if(this[vt].has(i))return this[vt].get(i)||!1;throw new Error(`The provided selector \`${i}\` is not being observed.`)}}return e=vt,o}var Da=Object.defineProperty,qa=Object.getOwnPropertyDescriptor,Er=(a,t,e,r)=>{for(var o=r>1?void 0:r?qa(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Da(t,e,o),o};const _e=Symbol("assignedNodes");function so(a,t){var e;class r extends a{constructor(...s){super(s),this.slotHasContent=!1,new er(this,{config:{characterData:!0,subtree:!0},callback:i=>{for(const c of i)if(c.type==="characterData"){this.manageTextObservedSlot();return}}})}manageTextObservedSlot(){if(!this[_e])return;const s=[...this[_e]].filter(i=>i.tagName?!0:i.textContent?i.textContent.trim():!1);this.slotHasContent=s.length>0}update(s){if(!this.hasUpdated){const{childNodes:i}=this,c=[...i].filter(n=>n.tagName?t?n.getAttribute("slot")===t:!n.hasAttribute("slot"):n.textContent?n.textContent.trim():!1);this.slotHasContent=c.length>0}super.update(s)}firstUpdated(s){super.firstUpdated(s),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return e=_e,Er([l({type:Boolean,attribute:!1})],r.prototype,"slotHasContent",2),Er([jo(t,!0)],r.prototype,e,2),r}function Ba(a){return typeof window<"u"&&window.navigator!=null?a.test(window.navigator.userAgent):!1}function rr(a){return typeof window<"u"&&window.navigator!=null?a.test(window.navigator.platform):!1}function Ha(){return rr(/^Mac/)}function Ua(){return rr(/^iPhone/)}function Ra(){return rr(/^iPad/)||Ha()&&navigator.maxTouchPoints>1}function Ga(){return Ua()||Ra()}function Ka(){return Ba(/Android/)}var Va=Object.defineProperty,Ya=Object.getOwnPropertyDescriptor,Ee=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ya(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Va(t,e,o),o};class Ht extends ao(so(Ma(et,'[slot="icon"]'))){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return this.slotHasContent}get focusElement(){return this}get buttonContent(){const t=[d`
        ...
        `}renderButton(){return d`
            ${this.buttonContent}
        `}render(){return this.href&&this.href.length>0?this.renderAnchor():this.renderButton()}handleKeydown(t){const{code:e}=t;switch(e){case"Space":t.preventDefault(),typeof this.href>"u"&&(this.addEventListener("keyup",this.handleKeyup),this.active=!0);break}}handleKeypress(t){const{code:e}=t;switch(e){case"Enter":case"NumpadEnter":this.click();break}}handleKeyup(t){const{code:e}=t;switch(e){case"Space":this.removeEventListener("keyup",this.handleKeyup),this.active=!1,this.click();break}}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}manageAnchor(){this.href&&this.href.length>0?(this.getAttribute("role")==="button"&&this.setAttribute("role","link"),this.removeEventListener("click",this.shouldProxyClick)):((!this.hasAttribute("role")||this.getAttribute("role")==="link")&&this.setAttribute("role","button"),this.addEventListener("click",this.shouldProxyClick))}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAnchor(),this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keypress",this.handleKeypress),this.addEventListener("pointerdown",this.handlePointerdown)}updated(t){super.updated(t),t.has("href")&&this.manageAnchor(),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("focusout",this.handleRemoveActive),this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointercancel",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("focusout",this.handleRemoveActive),this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointercancel",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1)}}Ee([l({type:Boolean,reflect:!0})],Ht.prototype,"active",2),Ee([l({type:String})],Ht.prototype,"type",2),Ee([W(".anchor")],Ht.prototype,"anchorElement",2);const Xa=v`
...
`,Wa=Xa;class or extends Ht{static get styles(){return[Wa]}}const Za=v`
...
`,ts=Qa;var es=Object.defineProperty,rs=Object.getOwnPropertyDescriptor,Ar=(a,t,e,r)=>{for(var o=r>1?void 0:r?rs(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&es(t,e,o),o};class q extends ot{static get styles(){return[ts]}render(){return d`
            <slot></slot>
        `}}Ar([l()],q.prototype,"label",2),Ar([l({reflect:!0})],q.prototype,"size",2);let Ge;const pt=function(a,...t){return Ge?Ge(a,...t):t.reduce((e,r,o)=>e+r+a[o+1],a[0])},mt=a=>{Ge=a},os=()=>pt`<svg
  ...
  >
    ...
    />
  </svg>`;class as extends q{render(){return mt(d),os()}}customElements.define("sp-icon-cross75",as);const ss=()=>pt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`;class is extends q{render(){return mt(d),ss()}}customElements.define("sp-icon-cross100",is);const cs=()=>pt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`;class ls extends q{render(){return mt(d),cs()}}customElements.define("sp-icon-cross200",ls);const ns=()=>pt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`;class us extends q{render(){return mt(d),ns()}}customElements.define("sp-icon-cross300",us);const ds=v`
...
`,io=ds;var ps=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,bs=(a,t,e,r)=>{for(var o=r>1?void 0:r?ms(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&ps(t,e,o),o};const hs={s:()=>d`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>d`
        ...
        ></sp-icon-cross300>
    `};class co extends dt(or){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Ja,io]}get buttonContent(){return[hs[this.size]()]}}bs([l({reflect:!0})],co.prototype,"variant",2);customElements.define("sp-close-button",co);let Ke;const me=function(a,...t){return Ke?Ke(a,...t):t.reduce((e,r,o)=>e+r+a[o+1],a[0])},be=a=>{Ke=a},gs=({width:a=24,height:t=24,hidden:e=!1,title:r="Alert"}={})=>me`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${a}"
  ...
  >
    ...
    />
  </svg>`;class vs extends q{render(){return be(d),gs({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-alert",vs);const fs=({width:a=24,height:t=24,hidden:e=!1,title:r="Info"}={})=>me`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${a}"
  ...
  >
    ...
    />
  </svg>`;class ys extends q{render(){return be(d),fs({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-info",ys);const ks=({width:a=24,height:t=24,hidden:e=!1,title:r="Checkmark Circle"}={})=>me`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${a}"
    height="${t}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;class xs extends q{render(){return be(d),ks({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-checkmark-circle",xs);const ws=v`
...
`,zs=ws;var $s=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,Ae=(a,t,e,r)=>{for(var o=r>1?void 0:r?Cs(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&$s(t,e,o),o};const Ss=["negative","positive","info","error","warning"];class oe extends ot{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[zs]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,r=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",r)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Ss.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return d`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
                `;case"negative":case"error":case"warning":return d`
                    <sp-icon-alert label="Error" class="type"></sp-icon-alert>
                `;case"positive":case"success":return d`
                    <sp-icon-checkmark-circle
                        label="Success"
                        class="type"
                    ></sp-icon-checkmark-circle>
                `;default:return d``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}shouldClose(){this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))&&this.close()}close(){this.open=!1}render(){return d`
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}Ae([l({type:Boolean,reflect:!0})],oe.prototype,"open",2),Ae([l({type:Number})],oe.prototype,"timeout",1),Ae([l({type:String})],oe.prototype,"variant",1);customElements.define("sp-toast",oe);const _s=v`
...
`,Es=_s;var As=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,Te=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ts(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&As(t,e,o),o};const Os=["accent","primary","secondary","negative","white","black"];class ae extends dt(or){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,Es]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":this._variant="white",this.treatment="outline";break;default:Os.includes(t)?this._variant=t:this._variant="accent";break}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}Te([l()],ae.prototype,"variant",1),Te([l({reflect:!0})],ae.prototype,"treatment",2),Te([l({type:Boolean})],ae.prototype,"quiet",1);const Ps=v`
...
`,Is=Ps;var Ns=Object.defineProperty,js=Object.getOwnPropertyDescriptor,Ls=(a,t,e,r)=>{for(var o=r>1?void 0:r?js(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Ns(t,e,o),o};const Fs={s:()=>d`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>d`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class lo extends dt(or){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Is,io]}get buttonContent(){return[Fs[this.size]()]}render(){return d`
            <div class="fill">${super.render()}</div>
        `}}Ls([l({reflect:!0})],lo.prototype,"variant",2);const Ms=v`
...
`,Bs=qs,Hs=()=>pt`<svg
  ...
  >
    ...
    />
  </svg>`;class Us extends q{render(){return mt(d),Hs()}}customElements.define("sp-icon-corner-triangle300",Us);var Rs=Object.defineProperty,Gs=Object.getOwnPropertyDescriptor,Z=(a,t,e,r)=>{for(var o=r>1?void 0:r?Gs(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Rs(t,e,o),o};const Ks={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"},Vs=300;let Tr;class Y extends dt(Ht,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[Ds,Bs]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){t.button===0&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),Tr=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},Vs))}onPointerup(){clearTimeout(Tr),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:r}=t;(e==="Space"||r&&e==="ArrowDown")&&(t.preventDefault(),e==="ArrowDown"&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:r}=t;(e==="Space"||r&&e==="ArrowDown")&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(d`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${Ks[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const e=this.role==="button"&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(e?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}Z([l({type:Boolean,reflect:!0})],Y.prototype,"emphasized",2),Z([l({type:Boolean,reflect:!0,attribute:"hold-affordance"})],Y.prototype,"holdAffordance",2),Z([l({type:Boolean,reflect:!0})],Y.prototype,"quiet",2),Z([l({reflect:!0})],Y.prototype,"role",2),Z([l({type:Boolean,reflect:!0})],Y.prototype,"selected",2),Z([l({type:Boolean,reflect:!0})],Y.prototype,"toggles",2),Z([l({reflect:!0})],Y.prototype,"variant",2),Z([l({type:String})],Y.prototype,"value",1);customElements.define("sp-action-button",Y);var Ys=Object.defineProperty,Xs=Object.getOwnPropertyDescriptor,G=(a,t,e,r)=>{for(var o=r>1?void 0:r?Xs(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Ys(t,e,o),o};class B extends j{constructor(){super(...arguments),this.id="",this.value="",this.type="token",this.isFaded=!1,this.isIntersect=!1,this.selected=!1,this.selectionAncestor=!1,this.selectionDescendent=!1,this.hasDownstream=!1,this.hoverUpstream=!1,this.isValidDrag=!1,this.decomposedValues=[],this.rowCount=1,this.pointerOverDepth=0,this.isInteractingWithButton=!1,this.fillColor="#000000",this.textColor="#FFFFFF"}willUpdate(t){if(t.has("value")){const e=this.value.split(Jr);e.length===1&&e[0]===""?this.decomposedValues=[]:this.decomposedValues=e.map(r=>{const o=r.split(Zr);return[o[0],o[1]||""]}),this.rowCount=Math.max(this.decomposedValues.length,1)}if(this.selected)this.fillColor="--spectrum-yellow-visual-color",this.textColor="--spectrum-yellow-100";else{let e="celery",r=200,o=900;this.type==="token"?(e=this.selectionDescendent?"fuchsia":"purple",(this.isIntersect||this.selectionDescendent&&this.selectionAncestor)&&(e="orange",r=600,o=1300)):this.type==="component"?(e="gray",this.hasDownstream&&(r=300)):this.type==="orphan-category"&&(e="cyan",this.hasDownstream&&(r=300)),this.isFaded&&(r-=100,o-=400),this.hoverUpstream&&(o=Math.min(1300,o+400)),this.fillColor=`--spectrum-${e}-${r}`,this.textColor=`--spectrum-${e}-${o}`}}preventDefault(t){return t.preventDefault&&t.preventDefault(),t.stopPropagation&&t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),!1}handlePointerDownOnIcon(){this.isInteractingWithButton=!0}handlePointerUpOnIcon(){this.isInteractingWithButton=!1}handlePointerDown(t){var r;if(this.gesture&&this.gesture.active||this.isInteractingWithButton)return;const e=(r=this.shadowRoot)==null?void 0:r.getElementById("gesture-target");e&&(x(this,"node-pointerdown",{id:this.id,data:t.detail}),this.gesture=new pe(t,e),(t.ctrlKey||t.altKey||t.metaKey||t.shiftKey)&&(this.isValidDrag=!0,this.preventDefault(t)))}handlePointerOver(){this.pointerOverDepth++,x(this,"node-pointerover",{id:this.id})}handlePointerOut(){setTimeout(()=>{this.pointerOverDepth--,this.pointerOverDepth===0&&x(this,"node-pointerout",{id:this.id})},1)}handleDragMove(t){!this.gesture||!this.isValidDrag||x(this,"node-dragmove",{id:this.id,data:t.detail})}handleDragStart(t){this.gesture&&((t.detail.ctrlKey||t.detail.altKey||t.detail.metaKey||t.detail.shiftKey)&&(this.isValidDrag=!0),x(this,"node-dragstart",{id:this.id,data:t.detail}))}handleDragEnd(t){this.gesture&&(this.isValidDrag=!1,x(this,"node-dragend",{id:this.id,data:t.detail}))}handleClick(t){x(this,"node-click",{id:this.id,shiftKey:t.detail.shiftKey,ctrlKey:t.detail.ctrlKey,metaKey:t.detail.metaKey,altKey:t.detail.altKey})}handleSingleClick(t){x(this,"node-singleclick",{id:this.id,shiftKey:t.detail.shiftKey,ctrlKey:t.detail.ctrlKey,metaKey:t.detail.metaKey,altKey:t.detail.altKey})}handleDoubleClick(t){x(this,"node-doubleclick",{id:this.id,shiftKey:t.detail.shiftKey,ctrlKey:t.detail.ctrlKey,metaKey:t.detail.metaKey,altKey:t.detail.altKey})}copyToClipboard(t){navigator.clipboard.writeText(this.id).then(()=>{x(this,"copied-to-clipboard",{id:this.id})},()=>{console.info("FAILED TO COPY TO CLIPBOARD")}),t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation()}get valueHtml(){return this.decomposedValues.length===0?d``:d`
      <ol>${this.decomposedValues.map(t=>d`<li><b>${t[1]||"*"}</b><i>${t[0]}</i></li>`)}</ol>
    `}render(){return d`
      <div
        ...
        style="background-color:var(${this.fillColor});color:var(${this.textColor});height:${this.rowCount*Me+(this.rowCount-1)*Qr+to*2}px;"
      >
        <h3>${this.id}</h3>
        <i
  ...
  `;G([l({type:String})],B.prototype,"id",2);G([l({type:String})],B.prototype,"value",2);G([l({type:String})],B.prototype,"type",2);G([l({type:Boolean})],B.prototype,"isFaded",2);G([l({type:Boolean})],B.prototype,"isIntersect",2);G([l({type:Boolean})],B.prototype,"selected",2);G([l({type:Boolean})],B.prototype,"selectionAncestor",2);G([l({type:Boolean})],B.prototype,"selectionDescendent",2);G([l({type:Boolean})],B.prototype,"hasDownstream",2);G([l({type:Boolean})],B.prototype,"hoverUpstream",2);customElements.define("token-graph-node",B);var Ws=Object.defineProperty,Zs=Object.getOwnPropertyDescriptor,at=(a,t,e,r)=>{for(var o=r>1?void 0:r?Zs(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Ws(t,e,o),o};const Zt=10;function Js(a,t,e,r,o,s,i,c){const n=(-3*a+9*e-9*i+3*o)/8,u=(-3*t+9*r-9*c+3*s)/8;return(Math.atan2(u,n)+Math.PI)*180/Math.PI}function ft(a){return Math.round(a*10)/10}class K extends j{constructor(){super(...arguments),this.fromX=0,this.fromY=0,this.toX=0,this.toY=0,this.role="descendentPath",this.isHighlighted=!1,this.isFaded=!1,this.label="",this.fillLabel="",this.top=0,this.left=0,this.width=0,this.height=0,this.Ax=0,this.Ay=0,this.Bx=0,this.By=0,this.angle=0,this.handleDistance=0,this.fillColor="#000000",this.labelColor="#FFFFFF"}willUpdate(t){if(t.has("role")||t.has("isFaded")||t.has("isHighlighted")){let i="celery",c=300,n=900;switch(this.role){case"selectionConnection":i="orange",c=300,n=1100;break;case"ancestorPath":i="purple";break;case"descendentPath":i="fuchsia";break}this.isFaded&&(c-=200,n-=200),this.isHighlighted&&(c+=200,n+=200),this.fillColor=`--spectrum-${i}-${c}`,this.labelColor=`--spectrum-${i}-${n}`}const e=Math.min(this.fromX,this.toX),r=Math.min(this.fromY,this.toY);this.fillLabel=new Array(this.label.length+2).join("█");const o=Math.sqrt(Math.pow(this.fromX-this.toX,2)+Math.pow(this.fromY-this.toY,2));this.handleDistance=o/3,this.angle=Js(this.fromX,this.fromY,this.fromX+this.handleDistance,this.fromY,this.toX-this.handleDistance,this.toY,this.toX,this.toY);const s=Math.max(0,this.handleDistance-(this.toX-this.fromX));this.Ax=ft(this.fromX-e+s/2),this.Ay=ft(this.fromY-r+Zt/2),this.Bx=ft(this.toX-e+s/2),this.By=ft(this.toY-r+Zt/2),this.top=ft(r-Zt/2),this.left=ft(e-s/2),this.width=Math.ceil(Math.abs(this.fromX-this.toX)+s),this.height=Math.ceil(Math.abs(this.fromY-this.toY)+Zt)}render(){return d`
      <svg style="top:${this.top}px;left:${this.left}px;" width=${this.width} height=${this.height}>
        <path
            d="M ${this.Ax},${this.Ay} C ${this.Ax+this.handleDistance},${this.Ay} ${this.Bx-this.handleDistance},${this.By} ${this.Bx},${this.By}"
            stroke="var(${this.fillColor})"
            stroke-width="2"
            fill="none"
          />
        ${this.label?fr`<g transform="rotate(${this.angle},${this.width/2},${this.height/2})">
            <text font-family="Courier New, monospace" x="50%" y="50%" fill="var(${this.fillColor})" text-anchor="middle" font-size="smaller" dominant-baseline="middle">◀${this.fillLabel}▶</text>
            <text font-family="Courier New, monospace" x="50%" y="50%" fill="var(${this.labelColor})" text-anchor="middle" font-size="smaller" dominant-baseline="middle">${this.label}</text>
            </g>
          `:fr``}
      </svg>
    `}}K.styles=v`
  ...
  `;at([l({type:Number})],K.prototype,"fromX",2);at([l({type:Number})],K.prototype,"fromY",2);at([l({type:Number})],K.prototype,"toX",2);at([l({type:Number})],K.prototype,"toY",2);at([l({type:String})],K.prototype,"role",2);at([l({type:Boolean})],K.prototype,"isHighlighted",2);at([l({type:Boolean})],K.prototype,"isFaded",2);at([l({type:String})],K.prototype,"label",2);customElements.define("token-graph-adjacency",K);var Qs=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,Ot=(a,t,e,r)=>{for(var o=r>1?void 0:r?ti(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Qs(t,e,o),o};function ei(a){return 1<<31-Math.clz32(a)}let rt=class extends j{constructor(){super(...arguments),this.scale=1,this.posx=0,this.posy=0,this.theme="paper",this.size=7,this.maximumRepeatingTileSize=200,this.cellFadeOutThresh=50,this.lineWidth=1,this.lineColorR=0,this.lineColorG=0,this.lineColorB=0,this.backgroundColor="#000"}willUpdate(a){if(a.has("theme"))switch(this.theme){case"darkest":case"dark":this.lineColorR=40,this.lineColorG=40,this.lineColorB=40,this.backgroundColor="#000000";break;case"light":case"wireframe":this.lineColorR=230,this.lineColorG=230,this.lineColorB=230,this.backgroundColor="#FFFFFF";break;case"paper":default:this.lineColorR=167,this.lineColorG=220,this.lineColorB=240,this.backgroundColor="#F5FFFA";break}}render(){const{lineColorR:a,lineColorG:t,lineColorB:e,backgroundColor:r,cellFadeOutThresh:o,posx:s,posy:i,scale:c,size:n,maximumRepeatingTileSize:u,lineWidth:m}=this,b=u/(n*4);let h=c/b*u,g=u;h>u&&(g=h);const f=Math.min(16,ei(g/h)),w=h*f,S=Math.max(0,2*((g-g+w)/g)-.5),$=.5+.5*Math.max(0,S*2-1),L=Array.from({length:f},(k,N)=>{const V=N*h,D=V+m,It=D,it=(N+1)*h,ct=N===0||N%8===0?1:N===f/2?$:.5,gt=`rgba(${a},${t},${e},${ct.toFixed(2)})`;return`${gt} ${V.toFixed(1)}px,
              ${gt} ${D.toFixed(1)}px,
              transparent ${It.toFixed(1)}px,
              transparent ${it.toFixed(1)}px`}).join(", "),A=Math.sqrt(Math.min(1,h/o)),I={backgroundImage:`linear-gradient(to right, ${L}), linear-gradient(to bottom, ${L})`,backgroundSize:`${w.toFixed(2)}px ${w.toFixed(2)}px`,backgroundPosition:`${s.toFixed(2)}px ${i.toFixed(2)}px`,opacity:`${.1+.9*A}`};return d`
  ...
  `;Ot([l({type:Number})],rt.prototype,"scale",2);Ot([l({type:Number})],rt.prototype,"posx",2);Ot([l({type:Number})],rt.prototype,"posy",2);Ot([l({type:String})],rt.prototype,"theme",2);Ot([l({type:Number})],rt.prototype,"size",2);rt=Ot([Oo("graph-grid")],rt);var ri=Object.defineProperty,oi=Object.getOwnPropertyDescriptor,no=(a,t,e,r)=>{for(var o=r>1?void 0:r?oi(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&ri(t,e,o),o};class he extends j{constructor(){super(),this.appState=_t.DEFAULT_STATE,this.graphState=R.DEFAULT_STATE,this.nodeIds=[],this._priorComponentsCacheStr="",this._priorGraphState=R.DEFAULT_STATE,this._gestureStartZoom=1,this._isGestureActive=!1,this.adjacencyTuples=[],this.debouncedAfterWheel=()=>{},this.debouncedAfterWheel=Fo(this._debouncedAfterWheel.bind(this),150)}willUpdate(t){if(t.has("graphState")){const{nodes:e,adjacencyList:r}=this.graphState,o=[];for(const s in r){const i=r[s];for(let c=0;c<i.length;c++){const n=i[c];o.push([s,n])}}this.nodeIds=Object.keys(e),this.adjacencyTuples=o,this._priorGraphState=this.graphState}}handleZoomGestureEnd(t){this._gestureStartZoom=1,this._isGestureActive=!1,t.preventDefault(),x(this,"generic-gesture-end",{id:this.id,data:t.detail})}handleZoomGestureStart(t){this._gestureStartZoom=this.appState.zoom,this._isGestureActive=!0,t.preventDefault(),x(this,"generic-gesture-start",{id:this.id,data:t.detail})}handleZoomGesture(t){let e=0;if(t.deltaY&&!this._isGestureActive){const r=this.appState.zoom,o=-t.deltaY*.0075*r;e=r+o}else t.scale&&(e=this._gestureStartZoom*t.scale);if(e){e=Math.min(qe,Math.max(De,e));const r=e/this.appState.zoom,o=this.appState.panX-t.pageX,s=this.appState.panY-t.pageY,i=t.pageX+o*r,c=t.pageY+s*r;x(this,"set-panning-position",{x:i,y:c}),x(this,"set-zoom",{value:e})}t.preventDefault()}_debouncedAfterWheel(){x(this,"generic-gesture-end",{id:this.id})}handleWheelEvents(t){if(x(this,"generic-gesture-start",{id:this.id}),this.debouncedAfterWheel(),t.ctrlKey||t.altKey||t.metaKey||t.shiftKey)return this.handleZoomGesture(t);x(this,"panning-input-delta",{x:-t.deltaX*2,y:-t.deltaY*2}),t.preventDefault()}handlePointerDown(t){var r;if(this.gesture&&this.gesture.active)return;const e=(r=this.shadowRoot)==null?void 0:r.getElementById("panning-drag-surface");e&&(this.gesture=new pe(t,e),t.preventDefault(),t.stopPropagation())}handleDragStart(t){x(this,"generic-gesture-start",{id:this.id,data:t.detail})}handleDragEnd(t){x(this,"generic-gesture-end",{id:this.id,data:t.detail})}handleDragMove(t){this.gesture&&this.gesture.id===t.detail.gestureId&&x(this,"panning-input-delta",{x:t.detail.deltaX,y:t.detail.deltaY})}render(){const{isDragging:t,zoom:e,panX:r,panY:o,selectedTokens:s,selectedComponents:i,selectionDescendentIntersectNodes:c,selectionAncestorNodes:n,selectionDescendentNodes:u,hoverUpstreamNodes:m,spectrumColorTheme:b}=this.appState;let p=n.filter(y=>u.includes(y));const h=[...i,...s];p=[...p,...c],p=p.filter(y=>!h.includes(y));const g=p.length>0,f=[...p,...h],w=[e.toFixed(3),0,0,e.toFixed(3),r.toFixed(0),o.toFixed(0)],S=t?[]:m;return d`
      <div
        ...
        <div class="contents ${g?"focus-mode":""}" style="transform: matrix(${w.join(",")});">
          ${He(this.adjacencyTuples,y=>y.join(":"),y=>{const[$,L]=y,A=this.graphState.nodes[$],I=this.graphState.nodes[L];if(!A||!I)return d``;const k=A.adjacencyLabels?A.adjacencyLabels[I.id]:"",N=A.x+Je,V=A.y+Fe/2,D=I.x,It=I.y+Fe/2,it=n.indexOf(A.id)>=0&&n.indexOf(I.id)>=0,ct=u.indexOf(A.id)>=0&&u.indexOf(I.id)>=0,gt=S.indexOf(A.id)>=0&&S.indexOf(I.id)>=0,cr=f.indexOf($)>=0&&f.indexOf(L)>=0,ve=g&&!cr,lr=it&&ct?"selectionConnection":it?"ancestorPath":"descendentPath",Wt=gt||it&&ct;return d`
              ...
              ></token-graph-adjacency>
            `})}
          ${He(this.nodeIds,y=>y,y=>{const{type:$,value:L="",x:A,y:I}=this.graphState.nodes[y],k=!!this.graphState.adjacencyList[y],N=s.indexOf(y)>=0||i.indexOf(y)>=0,V=p.indexOf(y)>=0;return d`
              <token-graph-node
  ...
  `;no([l({type:Object})],he.prototype,"appState",2);no([l({type:Object})],he.prototype,"graphState",2);customElements.define("token-graph",he);var ai=Object.defineProperty,si=Object.getOwnPropertyDescriptor,Oe=(a,t,e,r)=>{for(var o=r>1?void 0:r?si(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&ai(t,e,o),o};class se extends et{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly){this.inputElement.checked=this.checked;return}this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return d`
            <input
                id="input"
            ...
            />
        `}}Oe([l({type:Boolean,reflect:!0})],se.prototype,"checked",2),Oe([l({type:Boolean,reflect:!0})],se.prototype,"readonly",2),Oe([W("#input")],se.prototype,"inputElement",2);const ii=v`
...
`,li=ci;var ni=Object.defineProperty,ui=Object.getOwnPropertyDescriptor,di=(a,t,e,r)=>{for(var o=r>1?void 0:r?ui(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&ni(t,e,o),o};class uo extends dt(se){constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[Or,li]:[Or]}render(){return d`
            ${super.render()}
            <span id="switch"></span>
            <label id="label" for="input"><slot></slot></label>
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("role","switch")}updated(t){t.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}di([l({type:Boolean,reflect:!0})],uo.prototype,"emphasized",2);customElements.define("sp-switch",uo);customElements.define("sp-button",ae);const pi=v`
...
`,mi=pi;var bi=Object.defineProperty,hi=Object.getOwnPropertyDescriptor,gi=(a,t,e,r)=>{for(var o=r>1?void 0:r?hi(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&bi(t,e,o),o};class po extends dt(ot){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[mi]}handleSlotchange({target:t}){t.assignedElements().forEach(e=>{e.size=this.size})}render(){return d`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}gi([l({type:Boolean,reflect:!0})],po.prototype,"vertical",2);customElements.define("sp-button-group",po);const vi=v`
...
`,fi=vi;var yi=Object.defineProperty,ki=Object.getOwnPropertyDescriptor,Pe=(a,t,e,r)=>{for(var o=r>1?void 0:r?ki(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&yi(t,e,o),o};class ie extends ao(et){static get styles(){return[fi]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}Pe([W("#anchor")],ie.prototype,"anchorElement",2),Pe([l({type:String,reflect:!0})],ie.prototype,"variant",2),Pe([l({type:String,reflect:!0})],ie.prototype,"static",2);customElements.define("sp-link",ie);const xi=async(a,t,e,r)=>{const{Overlay:o}=await tr(()=>import("./overlay-a41e9a0e.js"),[],import.meta.url);return o.open(a,t,e,r)},wi=v`
:host([disabled]) ::slotted([slot=trigger]){pointer-events:none}#overlay-content slot{display:none}
`,zi=wi;var $i=Object.defineProperty,Ci=Object.getOwnPropertyDescriptor,yt=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ci(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&$i(t,e,o),o};const Si={touch:"Double tap and long press for additional options",keyboard:"Press Space or Alt+Down Arrow for additional options",mouse:"Click and hold for additional options"},mo=class extends ot{constructor(){super(...arguments),this.placement="bottom",this.offset=6,this.disabled=!1,this.hasLongpressContent=!1,this._longpressId="longpress-describedby-descriptor",this.abortOverlay=()=>{},this.openStatePromise=Promise.resolve()}static get styles(){return[zi]}handleClose(t){t&&t.detail.interaction!==this.open&&t.detail.interaction!==this.type||this.removeAttribute("open")}render(){return d`
            <slot
                id="trigger"
        ...
        `}updated(t){if(super.updated(t),this.disabled&&t.has("disabled")){this.closeAllOverlays();return}t.has("open")&&this.manageOpen(),t.has("hasLongpressContent")&&this.manageLongpressDescriptor()}manageLongpressDescriptor(){const t=this.querySelector('[slot="trigger"]'),e=t.getAttribute("aria-describedby");let r=e?e.split(/\s+/):[];if(this.hasLongpressContent){this.longpressDescriptor||(this.longpressDescriptor=document.createElement("div"),this.longpressDescriptor.id=this._longpressId,this.longpressDescriptor.slot=this._longpressId);const o=Ga()||Ka()?"touch":"keyboard";this.longpressDescriptor.textContent=Si[o],this.appendChild(this.longpressDescriptor),r.push(this._longpressId)}else this.longpressDescriptor&&this.longpressDescriptor.remove(),r=r.filter(o=>o!==this._longpressId);r.length?t.setAttribute("aria-describedby",r.join(" ")):t.removeAttribute("aria-describedby")}closeAllOverlays(){this.abortOverlay&&this.abortOverlay(!0),["closeClickOverlay","closeHoverOverlay","closeLongpressOverlay"].forEach(async t=>{const e=this[t];e!=null&&(delete this[t],(await e)())}),this.overlaidContent=void 0}manageOpen(){var t;({click:()=>this.onTriggerClick(),hover:()=>this.onTriggerMouseEnter(),longpress:()=>this.onTriggerLongpress(),none:()=>this.closeAllOverlays()})[(t=this.open)!=null?t:"none"]()}async openOverlay(t,e,r,o){return this.openStatePromise=new Promise(s=>this.openStateResolver=s),this.addEventListener("sp-opened",()=>{this.openStateResolver()},{once:!0}),this.overlaidContent=r,mo.openOverlay(t,e,r,o)}get overlayOptions(){return{offset:this.offset,placement:this.placement,receivesFocus:!this.type||this.type==="inline"||this.open==="hover"?void 0:"auto"}}onTrigger(t){if(t.type==="mouseleave"&&this.open==="hover"&&t.relatedTarget===this.overlaidContent&&this.overlaidContent){this.overlaidContent.addEventListener("mouseleave",e=>{e.relatedTarget!==this.targetContent&&this.onTrigger(e)},{once:!0});return}if(!this.disabled)switch(t.type){case"mouseenter":case"focusin":!this.open&&this.hoverContent&&(this.open="hover");return;case"mouseleave":case"focusout":this.open==="hover"&&this.handleClose();return;case"click":this.clickContent&&(this.open=t.type);return;case"longpress":this.longpressContent&&(this._longpressEvent=t,this.open=t.type);return}}prepareToFocusOverlayContent(t){this.type==="modal"&&(Fa(t)||(t.tabIndex=0))}async onTriggerClick(){if(!this.targetContent||!this.clickContent||this.closeClickOverlay)return;const{targetContent:t,clickContent:e}=this;this.closeAllOverlays(),this.prepareToFocusOverlayContent(e),this.closeClickOverlay=this.openOverlay(t,this.type?this.type:"click",e,this.overlayOptions)}async onTriggerLongpress(){var t,e;if(!this.targetContent||!this.longpressContent||this.closeLongpressOverlay)return;const{targetContent:r,longpressContent:o}=this;this.closeAllOverlays(),this.prepareToFocusOverlayContent(o);const s=((e=(t=this._longpressEvent)==null?void 0:t.detail)==null?void 0:e.source)!=="keyboard";this.closeLongpressOverlay=this.openOverlay(r,this.type?this.type:"longpress",o,{...this.overlayOptions,receivesFocus:"auto",notImmediatelyClosable:s}),this._longpressEvent=void 0}async onTriggerMouseEnter(){if(!this.targetContent||!this.hoverContent||this.closeHoverOverlay)return;const t=new Promise(o=>{this.abortOverlay=o}),{targetContent:e,hoverContent:r}=this;this.closeHoverOverlay=this.openOverlay(e,"hover",r,{abortPromise:t,...this.overlayOptions})}onClickSlotChange(t){this.clickContent=this.extractSlotContentFromEvent(t),this.manageOpen()}onLongpressSlotChange(t){this.longpressContent=this.extractSlotContentFromEvent(t),this.hasLongpressContent=!!this.longpressContent||!!this.closeLongpressOverlay,this.manageOpen()}onHoverSlotChange(t){this.hoverContent=this.extractSlotContentFromEvent(t),this.manageOpen()}onTargetSlotChange(t){this.targetContent=this.extractSlotContentFromEvent(t)}extractSlotContentFromEvent(t){return t.target.assignedNodes({flatten:!0}).find(e=>e instanceof HTMLElement)}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.openStatePromise,t}disconnectedCallback(){this.closeAllOverlays(),super.disconnectedCallback()}};let J=mo;J.openOverlay=async(a,t,e,r)=>xi(a,t,e,r),yt([l({reflect:!0})],J.prototype,"placement",2),yt([l()],J.prototype,"type",2),yt([l({type:Number,reflect:!0})],J.prototype,"offset",2),yt([l({reflect:!0})],J.prototype,"open",2),yt([l({type:Boolean,reflect:!0})],J.prototype,"disabled",2),yt([Xr()],J.prototype,"hasLongpressContent",2);customElements.define("overlay-trigger",J);const _i=v`
...
`,Ei=_i;var Ai=Object.defineProperty,Ti=Object.getOwnPropertyDescriptor,Jt=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ti(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Ai(t,e,o),o};class Mt extends ot{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[Ei]}renderTip(){return d`
            <div id="tip">
                <svg
        ...
        `}connectedCallback(){super.connectedCallback(),this.addEventListener("sp-overlay-query",this.onOverlayQuery)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sp-overlay-query",this.onOverlayQuery)}onOverlayQuery(t){if(!t.target||t.target!==this)return;const e=this.shadowRoot.querySelector("#tip");e&&(t.detail.overlayContentTipElement=e)}render(){return d`
            <slot></slot>
            ${this.tip?this.renderTip():z}
        `}}Jt([l({type:Boolean,reflect:!0})],Mt.prototype,"dialog",2),Jt([l({type:Boolean,reflect:!0})],Mt.prototype,"open",2),Jt([l({reflect:!0})],Mt.prototype,"placement",2),Jt([l({type:Boolean,reflect:!0})],Mt.prototype,"tip",2);customElements.define("sp-popover",Mt);function bo(a,t,e){const r=a.getAttribute(t);let o=r?r.split(/\s+/):[];o=o.filter(s=>!e.find(i=>s===i)),o.length?a.setAttribute(t,o.join(" ")):a.removeAttribute(t)}function ho(a,t,e){const r=Array.isArray(e)?e:[e],o=a.getAttribute(t),s=o?o.split(/\s+/):[];return r.every(i=>s.indexOf(i)>-1)?()=>{}:(s.push(...r),a.setAttribute(t,s.join(" ")),()=>bo(a,t,r))}const go=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:r})=>{this.handleHelpText(r),this.handleNegativeHelpText(r)},this.host=t,this.instanceCount=go.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return this.mode==="internal"}render(t){return d`
        ...
        `}addId(){const t=this.helpTextElement?this.helpTextElement.id:this.id;this.conditionId=ho(this.host,"aria-describedby",t),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0}removeId(){this.conditionId&&(this.conditionId(),delete this.conditionId),!this.helpTextElement&&(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(t){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const e=t.assignedElements()[0];this.helpTextElement=e,e&&(e.id||(e.id=this.id),this.addId())}handleNegativeHelpText(t){t.name==="negative-help-text"&&t.assignedElements().forEach(e=>e.variant="negative")}};let vo=go;vo.instanceCount=0;function fo(a,{mode:t}={mode:"internal"}){class e extends a{constructor(){super(...arguments),this.helpTextManager=new vo(this,{mode:t})}get helpTextId(){return this.helpTextManager.id}renderHelpText(o){return this.helpTextManager.render(o)}}return e}const Oi=v`
...
`,Pi=Oi;var Ii=Object.defineProperty,Ni=Object.getOwnPropertyDescriptor,Qt=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ni(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Ii(t,e,o),o};class Dt extends fo(ot,{mode:"external"}){constructor(){super(...arguments),this.horizontal=!1,this.invalid=!1,this.label="",this.vertical=!1}static get styles(){return[Pi]}handleSlotchange(){}render(){return d`
            <div class="group" role="presentation">
                <slot @slotchange=${this.handleSlotchange}></slot>
            </div>
            ${this.renderHelpText(this.invalid)}
        `}updated(t){super.updated(t),t.has("label")&&(this.label?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}}Qt([l({type:Boolean,reflect:!0})],Dt.prototype,"horizontal",2),Qt([l({type:Boolean,reflect:!0})],Dt.prototype,"invalid",2),Qt([l()],Dt.prototype,"label",2),Qt([l({type:Boolean,reflect:!0})],Dt.prototype,"vertical",2);customElements.define("sp-field-group",Dt);const ji=()=>pt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`;class Li extends q{render(){return mt(d),ji()}}customElements.define("sp-icon-asterisk100",Li);const Fi=v`
...
`,Bi=qi;var Hi=Object.defineProperty,Ui=Object.getOwnPropertyDescriptor,kt=(a,t,e,r)=>{for(var o=r>1?void 0:r?Ui(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Hi(t,e,o),o};const ko=class extends dt(ot){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1,this.resolvedElement=new Di(this)}static get styles(){return[Bi,Mi]}handleClick(t){if(!this.target||this.disabled||t.defaultPrevented)return;this.target.focus();const e=this.getRootNode(),r=this.target,o=r.getRootNode(),s=o.host;o===e&&r.forceFocusVisible?r.forceFocusVisible():s&&s.forceFocusVisible&&s.forceFocusVisible()}addTarget(t){this.target=t.focusElement||t,this.target.getRootNode()===this.getRootNode()?ho(this.target,"aria-labelledby",[this.id]):this.target.setAttribute("aria-label",this.labelText)}removeTarget(){this.target&&(this.target.getRootNode()===this.getRootNode()?bo(this.target,"aria-labelledby",[this.id]):this.target.removeAttribute("aria-label"))}async manageTarget(){this.removeTarget();const t=this.resolvedElement.element;if(!t){this.target=t;return}t.localName.search("-")>0&&await customElements.whenDefined(t.localName),typeof t.updateComplete<"u"&&await t.updateComplete,this.addTarget(t)}get labelText(){const t=this.slotEl.assignedNodes({flatten:!0});return t.length?t.map(e=>(e.textContent||"").trim()).join(" "):""}render(){return d`
            <label>
                <slot></slot>
                ${this.required?d`
                          <sp-icon-asterisk100
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("click",this.handleClick)}willUpdate(t){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${ko.instanceCount++}`),t.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(t.has("id")||t.has(yo))&&this.manageTarget()}};let Q=ko;Q.instanceCount=0,kt([l({type:Boolean,reflect:!0})],Q.prototype,"disabled",2),kt([l({type:String})],Q.prototype,"id",2),kt([l({type:String})],Q.prototype,"for",2),kt([l({type:Boolean,reflect:!0})],Q.prototype,"required",2),kt([W("slot")],Q.prototype,"slotEl",2),kt([l({type:String,reflect:!0,attribute:"side-aligned"})],Q.prototype,"sideAligned",2);customElements.define("sp-field-label",Q);var Ri=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,Ki=(a,t,e,r)=>{for(var o=r>1?void 0:r?Gi(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Ri(t,e,o),o};class ar extends j{constructor(){super(...arguments),this.filters=[]}handleFilterChange(){var o;const r=[...((o=this.shadowRoot)==null?void 0:o.firstElementChild).getElementsByTagName("sp-switch")].reduce((s,i)=>{const c=i;return i.checked&&s.push(c.getAttribute("value")||""),s},[]);x(this,"filters-selected",{value:r})}listOfOptions(t){return Zo[t].map(e=>d`
      <sp-switch emphasized value=${e} ?checked=${this.filters.indexOf(e)>=0}>${e}</sp-switch>
    `)}get listOfCategorizedOptionLists(){return Wo.map(t=>d`
  ...
  `;Ki([l({type:Object})],ar.prototype,"filters",2);customElements.define("stvt-filters-menu",ar);let Ve=class extends Tt{constructor(t){if(super(t),this.it=z,t.type!==U.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===z||t==null)return this._t=void 0,this.it=t;if(t===M)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Ve.directiveName="unsafeHTML",Ve.resultType=1;const Vi=At(Ve);customElements.define("sp-clear-button",lo);const Yi=()=>pt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`;class Xi extends q{render(){return mt(d),Yi()}}customElements.define("sp-icon-checkmark100",Xi);const Wi=v`
...
`,Qi=Ji;var tc=Object.defineProperty,ec=Object.getOwnPropertyDescriptor,_=(a,t,e,r)=>{for(var o=r>1?void 0:r?ec(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&tc(t,e,o),o};const rc=["text","url","tel","email","password"];class E extends fo(et){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[Zi,Qi]}get type(){var t;return(t=rc.find(e=>e===this._type))!=null?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,r="none"){this.inputElement.setSelectionRange(t,e,r)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;this.inputElement.value=this.value.toString(),this.inputElement.setSelectionRange(t,t);return}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?d`
            ...
            `:this.valid?d`
                ...
                ></sp-icon-checkmark100>
            `:z}get displayValue(){return this.value.toString()}get renderMultiline(){return d`
        ...
        `}render(){return d`
            ...
            ${this.renderHelpText(this.invalid)}
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then(()=>{this.checkValidity()}),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),typeof this.minlength<"u"&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t),t}}_([l({attribute:"allowed-keys"})],E.prototype,"allowedKeys",2),_([l({type:Boolean,reflect:!0})],E.prototype,"focused",2),_([W(".input")],E.prototype,"inputElement",2),_([l({type:Boolean,reflect:!0})],E.prototype,"invalid",2),_([l()],E.prototype,"label",2),_([l()],E.prototype,"placeholder",2),_([l({attribute:"type",reflect:!0})],E.prototype,"_type",2),_([Xr()],E.prototype,"type",1),_([l()],E.prototype,"pattern",2),_([l({type:Boolean,reflect:!0})],E.prototype,"grows",2),_([l({type:Number})],E.prototype,"maxlength",2),_([l({type:Number})],E.prototype,"minlength",2),_([l({type:Boolean,reflect:!0})],E.prototype,"multiline",2),_([l({type:Boolean,reflect:!0})],E.prototype,"readonly",2),_([l({type:Boolean,reflect:!0})],E.prototype,"valid",2),_([l({type:String})],E.prototype,"value",1),_([l({type:Boolean,reflect:!0})],E.prototype,"quiet",2),_([l({type:Boolean,reflect:!0})],E.prototype,"required",2),_([l({type:String,reflect:!0})],E.prototype,"autocomplete",2);class sr extends E{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}_([l({type:String})],sr.prototype,"value",1);customElements.define("sp-textfield",sr);const oc=({width:a=24,height:t=24,hidden:e=!1,title:r="Magnify"}={})=>me`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${a}"
  ...
  >
    ...
    />
  </svg>`;class ac extends q{render(){return be(d),oc({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-magnify",ac);const sc=v`
...
`,ic=sc;var cc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,Ft=(a,t,e,r)=>{for(var o=r>1?void 0:r?lc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&cc(t,e,o),o};const nc=a=>a.stopPropagation();class zt extends sr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,ic]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||e!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return d`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}Ft([l()],zt.prototype,"action",2),Ft([l()],zt.prototype,"label",2),Ft([l()],zt.prototype,"method",2),Ft([l()],zt.prototype,"placeholder",2),Ft([W("#form")],zt.prototype,"form",2);customElements.define("sp-search",zt);function uc(){return new Worker(""+new URL("string-match-c1d19615.js",import.meta.url).href)}var dc=Object.defineProperty,pc=Object.getOwnPropertyDescriptor,Vt=(a,t,e,r)=>{for(var o=r>1?void 0:r?pc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&dc(t,e,o),o};const mc=v`rgb(0, 140, 186)`,bc=v`rgb(208, 208, 208)`,hc=v`rgb(211, 65, 213)`;class bt extends j{constructor(){super(),this.graphState=R.DEFAULT_STATE,this.dictionary=[],this.searchResults=[],this.searchQuery="",this.targetIndex=0,this.stringMatchWorker=new uc,this.stringMatchWorker.onmessage=this.handleStringMatchWorkerResponse.bind(this)}willUpdate(t){t.has("searchQuery")&&this.stringMatchWorker.postMessage({name:"find-matches",value:this.searchQuery}),t.has("dictionary")&&(this.stringMatchWorker.postMessage({name:"set-dictionary",value:this.dictionary}),this.stringMatchWorker.postMessage({name:"find-matches",value:this.searchQuery}))}handleStringMatchWorkerResponse(t){this.targetIndex=0,this.searchResults=t.data}handleChange(){var e;const t=(e=this.shadowRoot)==null?void 0:e.getElementById("search");this.searchQuery=t.value}selectItemAtIndex(t){var o;const e=this.searchResults[t];if(!e)return;const r=(o=this.shadowRoot)==null?void 0:o.getElementById("search");r.blur(),this.searchQuery="",r.value=this.searchQuery,x(this,"select-id",{id:e.value})}handlePointerDown(t){this.selectItemAtIndex(t)}setNewTargetIndex(t){var u,m;const e=(u=this.shadowRoot)==null?void 0:u.getElementById(`search-result-${t}`),r=(m=this.shadowRoot)==null?void 0:m.getElementById("list-container"),o=e.offsetHeight,s=r.offsetHeight,i=r.scrollTop,c=i+s,n=e.offsetTop;n<i&&(r.scrollTop=n),n>c-o&&(r.scrollTop=n+o-s),this.targetIndex=t}handleKeydown(t){var e;switch(t.code){case"KeyZ":t.stopImmediatePropagation(),t.stopPropagation();break;case"ArrowDown":let r=this.targetIndex+1;this.targetIndex++,this.searchResults.length<=r&&(r=0),this.setNewTargetIndex(r),t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation();break;case"ArrowUp":let o=this.targetIndex-1;o<0&&(o=this.searchResults.length-1),this.setNewTargetIndex(o),t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation();break;case"Enter":this.selectItemAtIndex(this.targetIndex);break;case"Escape":const s=(e=this.shadowRoot)==null?void 0:e.getElementById("search");s.blur(),this.searchQuery="",s.value=this.searchQuery;break}}render(){return d`
      <div>
        <sp-search
            @change=${this.handleChange}
  ...
  `;Vt([l({type:Object})],bt.prototype,"graphState",2);Vt([l({type:Object})],bt.prototype,"dictionary",2);Vt([l({type:Object})],bt.prototype,"searchResults",2);Vt([l({type:String})],bt.prototype,"searchQuery",2);Vt([l({type:Number})],bt.prototype,"targetIndex",2);customElements.define("stvt-search",bt);var gc=Object.defineProperty,vc=Object.getOwnPropertyDescriptor,ir=(a,t,e,r)=>{for(var o=r>1?void 0:r?vc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&gc(t,e,o),o};const fc=v`rgb(0, 140, 186)`,yc=v`rgb(208, 208, 208)`,kc=v`rgb(211, 65, 213)`;class Yt extends j{constructor(){super(...arguments),this.dictionary=[],this.selectedTokens=[],this.selectedComponents=["slider"],this.tabItems=[],this.graphNodeTypeLookup={}}willUpdate(t){(t.has("selectedTokens")||t.has("selectedComponents"))&&(this.tabItems=this.selectedComponents.concat(this.selectedTokens)),t.has("dictionary")&&this.dictionary.forEach(e=>this.graphNodeTypeLookup[e.value]=e.type)}handleWheelEvents(t){var e;if(Math.abs(t.deltaY)>Math.abs(t.deltaX)){const r=(e=this.shadowRoot)==null?void 0:e.getElementById("tab-scroller");r.scrollLeft+=t.deltaY,t.preventDefault()}}handleCloseTabClick(t){x(this,"close-tab",{value:t})}handleDeselectAll(){x(this,"close-all-tabs")}tabsItemHtml(t){return d`<li class=${this.graphNodeTypeLookup[t]}><i></i>${t}<button
      @click=${()=>this.handleCloseTabClick(t)}
    ><i></i></button></li>`}render(){const t=this.tabItems.length;return d`
      <div
        id="tab-scroller"
        class="tabs"
        @wheel=${this.handleWheelEvents}
  ...
  `;ir([l({type:Object})],Yt.prototype,"dictionary",2);ir([l({type:Object})],Yt.prototype,"selectedTokens",2);ir([l({type:Object})],Yt.prototype,"selectedComponents",2);customElements.define("stvt-tabs",Yt);var xc=Object.defineProperty,wc=Object.getOwnPropertyDescriptor,Pt=(a,t,e,r)=>{for(var o=r>1?void 0:r?wc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&xc(t,e,o),o};class st extends j{constructor(){super(...arguments),this.dictionary=[],this.filters=[],this.listOfComponents=[],this.selectedTokens=[],this.selectedComponents=["slider"],this.spectrumColorTheme="darkest"}handleSwitchValueChange(){var r;const e=((r=this.shadowRoot)==null?void 0:r.getElementById("spectrum-color-theme-switch")).checked?"light":"darkest";x(this,"set-spectrum-color-theme",{value:e})}toggleAbout(){}render(){const t=this.spectrumColorTheme==="light";return d`
      <section class="top">
        <div class="branding">
  ...
  `;Pt([l({type:Object})],st.prototype,"dictionary",2);Pt([l({type:Object})],st.prototype,"filters",2);Pt([l({type:Object})],st.prototype,"listOfComponents",2);Pt([l({type:Object})],st.prototype,"selectedTokens",2);Pt([l({type:Object})],st.prototype,"selectedComponents",2);Pt([l({type:String})],st.prototype,"spectrumColorTheme",2);customElements.define("stvt-sidebar",st);const xo=Symbol("language resolver updated");class zc{constructor(t){this.language=document.documentElement.lang||navigator.language,this.host=t,this.host.addController(this)}hostConnected(){this.resolveLanguage()}hostDisconnected(){var t;(t=this.unsubscribe)==null||t.call(this)}resolveLanguage(){const t=new CustomEvent("sp-language-context",{bubbles:!0,composed:!0,detail:{callback:(e,r)=>{const o=this.language;this.language=e,this.unsubscribe=r,this.host.requestUpdate(xo,o)}},cancelable:!0});this.host.dispatchEvent(t)}}let Ie=new Map,Ye=!1;try{Ye=new Intl.NumberFormat("de-DE",{signDisplay:"exceptZero"}).resolvedOptions().signDisplay==="exceptZero"}catch{}let ue=!1;try{ue=new Intl.NumberFormat("de-DE",{style:"unit",unit:"degree"}).resolvedOptions().style==="unit"}catch{}const wo={degree:{narrow:{default:"°","ja-JP":" 度","zh-TW":"度","sl-SI":" °"}}};class Pr{format(t){let e="";if(!Ye&&this.options.signDisplay!=null?e=Cc(this.numberFormatter,this.options.signDisplay,t):e=this.numberFormatter.format(t),this.options.style==="unit"&&!ue){var r;let{unit:o,unitDisplay:s="short",locale:i}=this.resolvedOptions(),c=(r=wo[o])===null||r===void 0?void 0:r[s];e+=c[i]||c.default}return e}formatToParts(t){return this.numberFormatter.formatToParts(t)}formatRange(t,e){if(typeof this.numberFormatter.formatRange=="function")return this.numberFormatter.formatRange(t,e);if(e<t)throw new RangeError("End date must be >= start date");return`${this.format(t)} – ${this.format(e)}`}formatRangeToParts(t,e){if(typeof this.numberFormatter.formatRangeToParts=="function")return this.numberFormatter.formatRangeToParts(t,e);if(e<t)throw new RangeError("End date must be >= start date");let r=this.numberFormatter.formatToParts(t),o=this.numberFormatter.formatToParts(e);return[...r.map(s=>({...s,source:"startRange"})),{type:"literal",value:" – ",source:"shared"},...o.map(s=>({...s,source:"endRange"}))]}resolvedOptions(){let t=this.numberFormatter.resolvedOptions();return!Ye&&this.options.signDisplay!=null&&(t={...t,signDisplay:this.options.signDisplay}),!ue&&this.options.style==="unit"&&(t={...t,style:"unit",unit:this.options.unit,unitDisplay:this.options.unitDisplay}),t}constructor(t,e={}){this.numberFormatter=$c(t,e),this.options=e}}function $c(a,t={}){let{numberingSystem:e}=t;if(e&&a.indexOf("-u-nu-")===-1&&(a=`${a}-u-nu-${e}`),t.style==="unit"&&!ue){var r;let{unit:i,unitDisplay:c="short"}=t;if(!i)throw new Error('unit option must be provided with style: "unit"');if(!(!((r=wo[i])===null||r===void 0)&&r[c]))throw new Error(`Unsupported unit ${i} with unitDisplay = ${c}`);t={...t,style:"decimal"}}let o=a+(t?Object.entries(t).sort((i,c)=>i[0]<c[0]?-1:1).join():"");if(Ie.has(o))return Ie.get(o);let s=new Intl.NumberFormat(a,t);return Ie.set(o,s),s}function Cc(a,t,e){if(t==="auto")return a.format(e);if(t==="never")return a.format(Math.abs(e));{let r=!1;if(t==="always"?r=e>0||Object.is(e,0):t==="exceptZero"&&(Object.is(e,-0)||Object.is(e,0)?e=Math.abs(e):r=e>0),r){let o=a.format(-e),s=a.format(e),i=o.replace(s,"").replace(/\u200e|\u061C/,"");return[...i].length!==1&&console.warn("@react-aria/i18n polyfill for NumberFormat signDisplay: Unsupported case"),o.replace(s,"!!!").replace(i,"+").replace("!!!",s)}else return a.format(e)}}const Sc=new RegExp("^.*\\(.*\\).*$"),_c=["latn","arab","hanidec"];class il{parse(t){return Ne(this.locale,this.options,t).parse(t)}isValidPartialNumber(t,e,r){return Ne(this.locale,this.options,t).isValidPartialNumber(t,e,r)}getNumberingSystem(t){return Ne(this.locale,this.options,t).options.numberingSystem}constructor(t,e={}){this.locale=t,this.options=e}}const Ir=new Map;function Ne(a,t,e){let r=Nr(a,t);if(!a.includes("-nu-")&&!r.isValidPartialNumber(e)){for(let o of _c)if(o!==r.options.numberingSystem){let s=Nr(a+(a.includes("-u-")?"-nu-":"-u-nu-")+o,t);if(s.isValidPartialNumber(e))return s}}return r}function Nr(a,t){let e=a+(t?Object.entries(t).sort((o,s)=>o[0]<s[0]?-1:1).join():""),r=Ir.get(e);return r||(r=new Ec(a,t),Ir.set(e,r)),r}class Ec{parse(t){let e=this.sanitize(t);e=te(e,this.symbols.group,"").replace(this.symbols.decimal,".").replace(this.symbols.minusSign,"-").replace(this.symbols.numeral,this.symbols.index);let r=e?+e:NaN;if(isNaN(r))return NaN;if(this.options.currencySign==="accounting"&&Sc.test(t)&&(r=-1*r),this.options.style==="percent"){r/=100;var o;r=+r.toFixed(((o=this.options.maximumFractionDigits)!==null&&o!==void 0?o:0)+2)}return r}sanitize(t){return t=t.replace(this.symbols.literals,""),t=t.replace("-",this.symbols.minusSign),this.options.numberingSystem==="arab"&&(t=t.replace(",",this.symbols.decimal),t=t.replace(String.fromCharCode(1548),this.symbols.decimal),t=te(t,".",this.symbols.group)),this.options.locale==="fr-FR"&&(t=te(t,".",String.fromCharCode(8239))),t}isValidPartialNumber(t,e=-1/0,r=1/0){return t=this.sanitize(t),t.startsWith(this.symbols.minusSign)&&e<0?t=t.slice(this.symbols.minusSign.length):this.symbols.plusSign&&t.startsWith(this.symbols.plusSign)&&r>0&&(t=t.slice(this.symbols.plusSign.length)),t.startsWith(this.symbols.group)?!1:(t=te(t,this.symbols.group,"").replace(this.symbols.numeral,"").replace(this.symbols.decimal,""),t.length===0)}constructor(t,e={}){this.formatter=new Intl.NumberFormat(t,e),this.options=this.formatter.resolvedOptions(),this.symbols=Ac(this.formatter,this.options,e)}}const jr=new Set(["decimal","fraction","integer","minusSign","plusSign","group"]);function Ac(a,t,e){var r,o,s,i;let c=a.formatToParts(-10000.111),n=a.formatToParts(10000.111),u=a.formatToParts(1);var m;let b=(m=(r=c.find(k=>k.type==="minusSign"))===null||r===void 0?void 0:r.value)!==null&&m!==void 0?m:"-",p=(o=n.find(k=>k.type==="plusSign"))===null||o===void 0?void 0:o.value;!p&&((e==null?void 0:e.signDisplay)==="exceptZero"||(e==null?void 0:e.signDisplay)==="always")&&(p="+");let h=(s=c.find(k=>k.type==="decimal"))===null||s===void 0?void 0:s.value,g=(i=c.find(k=>k.type==="group"))===null||i===void 0?void 0:i.value,f=c.filter(k=>!jr.has(k.type)).map(k=>Lr(k.value)),w=u.filter(k=>!jr.has(k.type)).map(k=>Lr(k.value)),S=[...new Set([...w,...f])].sort((k,N)=>N.length-k.length),y=S.length===0?new RegExp("[\\p{White_Space}]","gu"):new RegExp(`${S.join("|")}|[\\p{White_Space}]`,"gu"),$=[...new Intl.NumberFormat(t.locale,{useGrouping:!1}).format(9876543210)].reverse(),L=new Map($.map((k,N)=>[k,N])),A=new RegExp(`[${$.join("")}]`,"g");return{minusSign:b,plusSign:p,decimal:h,group:g,literals:y,numeral:A,index:k=>String(L.get(k))}}function te(a,t,e){return a.replaceAll?a.replaceAll(t,e):a.split(t).join(e)}function Lr(a){return a.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&")}var Tc=Object.defineProperty,Oc=Object.getOwnPropertyDescriptor,H=(a,t,e,r)=>{for(var o=r>1?void 0:r?Oc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Tc(t,e,o),o};const Pc={toNormalized(a,t,e){return(a-t)/(e-t)},fromNormalized(a,t,e){return a*(e-t)+t}},Ic={fromAttribute:a=>a==="previous"?a:parseFloat(a),toAttribute:a=>a.toString()},Nc={fromAttribute:a=>a==="next"?a:parseFloat(a),toAttribute:a=>a.toString()};class F extends et{constructor(){super(...arguments),this._forcedUnit="",this.dragging=!1,this.highlight=!1,this.name="",this.label="",this.getAriaHandleText=(t,e)=>e.format(t),this.languageResolver=new zc(this),this.normalization=Pc}get handleName(){return this.name}get focusElement(){var t,e;return(e=(t=this.handleController)==null?void 0:t.inputForHandle(this))!=null?e:this}update(t){var e;if(!this.hasUpdated){const{max:r,min:o}=this;this.value==null&&!isNaN(r)&&!isNaN(o)&&(this.value=r<o?o:o+(r-o)/2)}(t.has("formatOptions")||t.has(xo))&&delete this._numberFormatCache,t.has("value")&&t.get("value")!=null&&this.updateComplete.then(()=>{var r;(r=this.handleController)==null||r.setValueFromHandle(this)}),(e=this.handleController)==null||e.handleHasChanged(this),super.update(t)}firstUpdated(t){super.firstUpdated(t),this.dispatchEvent(new CustomEvent("sp-slider-handle-ready"))}dispatchInputEvent(){const t=new Event("input",{bubbles:!0,composed:!0});this.dispatchEvent(t)}getNumberFormat(){var t;if(!this._numberFormatCache||this.languageResolver.language!==this._numberFormatCache.language){let e;try{e=new Pr(this.languageResolver.language,this.formatOptions),this._forcedUnit=""}catch{const{style:o,unit:s,unitDisplay:i,...c}=this.formatOptions||{};o==="unit"&&(this._forcedUnit=s),e=new Pr(this.languageResolver.language,c)}this._numberFormatCache={language:this.languageResolver.language,numberFormat:e}}return(t=this._numberFormatCache)==null?void 0:t.numberFormat}get numberFormat(){if(this.formatOptions)return this.getNumberFormat()}}H([l({type:Number})],F.prototype,"value",2),H([l({type:Boolean,reflect:!0})],F.prototype,"dragging",2),H([l({type:Boolean})],F.prototype,"highlight",2),H([l({type:String})],F.prototype,"name",2),H([l({reflect:!0,converter:Ic})],F.prototype,"min",2),H([l({reflect:!0,converter:Nc})],F.prototype,"max",2),H([l({type:Number,reflect:!0})],F.prototype,"step",2),H([l({type:Object,attribute:"format-options"})],F.prototype,"formatOptions",2),H([l({type:String})],F.prototype,"label",2),H([l({attribute:!1})],F.prototype,"getAriaHandleText",2),H([l({attribute:!1})],F.prototype,"normalization",2);customElements.define("sp-slider-handle",F);const jc=v`
...
`,Lc=jc;class Fc{constructor(t){this.handles=new Map,this.model=[],this.handleOrder=[],this.handleOrientation=()=>{this.updateBoundingRect()},this.extractModelFromLightDom=()=>{let e=[...this.host.querySelectorAll('[slot="handle"]')];e.length===0&&(e=[this.host]),!e.some(r=>this.waitForUpgrade(r))&&(this.handles=new Map,this.handleOrder=[],e.forEach((r,o)=>{var s;(s=r.handleName)!=null&&s.length||(r.name=`handle${o+1}`),this.handles.set(r.handleName,r),this.handleOrder.push(r.handleName),r.handleController=this}),this.requestUpdate())},this.onInputChange=e=>{const r=e.target;r.model.handle.value=r.valueAsNumber,this.requestUpdate(),this.dispatchChangeEvent(r,r.model.handle)},this.onInputFocus=e=>{const r=e.target;let o;try{o=r.matches(":focus-visible")||this.host.matches(".focus-visible")}catch{o=this.host.matches(".focus-visible")}r.model.handle.highlight=o,this.requestUpdate()},this.onInputBlur=e=>{const r=e.target;r.model.handle.highlight=!1,this.requestUpdate()},this.onInputKeydown=e=>{const r=e.target;r.model.handle.highlight=!0,this.requestUpdate()},this.host=t,new er(this.host,{config:{subtree:!0,childList:!0},callback:()=>{this.extractModelFromLightDom()}}),this.extractModelFromLightDom()}get values(){const t={};for(const e of this.handles.values())t[e.handleName]=e.value;return t}get size(){return this.handles.size}inputForHandle(t){if(this.handles.has(t.handleName)){const{input:e}=this.getHandleElements(t);return e}throw new Error(`No input for handle "${t.name}"`)}requestUpdate(){this.host.hasUpdated&&this.host.requestUpdate()}setValueFromHandle(t){const e=this.getHandleElements(t);if(!e)return;const{input:r}=e;r.valueAsNumber===t.value?t.dragging&&t.dispatchInputEvent():(r.valueAsNumber=t.value,this.requestUpdate()),t.value=r.valueAsNumber}handleHasChanged(t){t!==this.host&&this.requestUpdate()}formattedValueForHandle(t){var e;const{handle:r}=t,o=(e=r.numberFormat)!=null?e:this.host.numberFormat;return r.getAriaHandleText(t.value,o)}get formattedValues(){const t=new Map;for(const e of this.model)t.set(e.name,this.formattedValueForHandle(e));return t}get focusElement(){const{input:t}=this.getActiveHandleElements();return this.host.editable&&!t.model.handle.dragging?this.host.numberField:t}hostConnected(){"orientation"in screen?screen.orientation.addEventListener("change",this.handleOrientation):window.addEventListener("orientationchange",this.handleOrientation)}hostDisconnected(){"orientation"in screen?screen.orientation.removeEventListener("change",this.handleOrientation):window.removeEventListener("orientationchange",this.handleOrientation)}hostUpdate(){this.updateModel()}waitForUpgrade(t){return t instanceof F?!1:(t.addEventListener("sp-slider-handle-ready",()=>this.extractModelFromLightDom(),{once:!0,passive:!0}),!0)}get activeHandle(){return this.handleOrder[this.handleOrder.length-1]}get activeHandleInputId(){const t=this.activeHandle;return`input-${this.model.findIndex(e=>e.name===t)}`}activateHandle(t){const e=this.handleOrder.findIndex(r=>r===t);e>=0&&this.handleOrder.splice(e,1),this.handleOrder.push(t)}getActiveHandleElements(){const t=this.activeHandle,e=this.handles.get(t),r=this.getHandleElements(e);return{model:e,...r}}getHandleElements(t){if(!this.handleRefMap){this.handleRefMap=new WeakMap;const e=this.host.shadowRoot.querySelectorAll(".handle > input");for(const r of e){const o=r,s=o.parentElement,i=this.handles.get(s.getAttribute("name"));i&&this.handleRefMap.set(i,{input:o,handle:s})}}return this.handleRefMap.get(t)}clearHandleComponentCache(){delete this.handleRefMap}get boundingClientRect(){return this._boundingClientRect||(this._boundingClientRect=this.host.track.getBoundingClientRect()),this._boundingClientRect}updateBoundingRect(){delete this._boundingClientRect}extractDataFromEvent(t){if(!this._activePointerEventData){let e=t.target.querySelector(":scope > .input");const r=!e,o=e?e.model:this.model.find(s=>s.name===this.activeHandle);!e&&o&&(e=o.handle.focusElement),this._activePointerEventData={input:e,model:o,resolvedInput:r}}return this._activePointerEventData}handlePointerdown(t){const{resolvedInput:e,model:r}=this.extractDataFromEvent(t);if(!r||this.host.disabled||t.button!==0){t.preventDefault();return}this.host.track.setPointerCapture(t.pointerId),this.updateBoundingRect(),t.pointerType==="mouse"&&this.host.labelEl.click(),this.draggingHandle=r.handle,r.handle.dragging=!0,this.activateHandle(r.name),e&&this.handlePointermove(t),this.requestUpdate()}handlePointerup(t){const{input:e,model:r}=this.extractDataFromEvent(t);delete this._activePointerEventData,r&&(t.pointerType==="mouse"&&this.host.labelEl.click(),this.cancelDrag(r),this.requestUpdate(),this.host.track.releasePointerCapture(t.pointerId),this.dispatchChangeEvent(e,r.handle))}handlePointermove(t){const{input:e,model:r}=this.extractDataFromEvent(t);!r||!this.draggingHandle||(t.stopPropagation(),e.value=this.calculateHandlePosition(t,r).toString(),r.handle.value=parseFloat(e.value),this.host.indeterminate=!1,this.requestUpdate())}cancelDrag(t){t=t||this.model.find(e=>e.name===this.activeHandle),t&&(t.handle.highlight=!1,delete this.draggingHandle,t.handle.dragging=!1)}dispatchChangeEvent(t,e){t.valueAsNumber=e.value;const r=new Event("change",{bubbles:!0,composed:!0});e.dispatchEvent(r)}calculateHandlePosition(t,e){const r=this.boundingClientRect,o=r.left,s=t.clientX,i=r.width,c=(this.host.isLTR?s-o:i-(s-o))/i;return e.normalization.fromNormalized(c,e.range.min,e.range.max)}renderHandle(t,e,r,o){var s;const i={handle:!0,dragging:((s=this.draggingHandle)==null?void 0:s.handleName)===t.name,"handle-highlight":t.highlight},c={[this.host.isLTR?"left":"right"]:`${t.normalizedValue*100}%`,"z-index":r.toString(),"background-color":`var(--spectrum-slider-handle-background-color-${e}, var(--spectrum-slider-handle-default-background-color))`,"border-color":`var(--spectrum-slider-handle-border-color-${e}, var(-spectrum-slider-handle-default-border-color))`},n=o?`label input-${e}`:"label";return d`
        ...
        `}render(){return this.clearHandleComponentCache(),this.model.map((t,e)=>{const r=this.handleOrder.indexOf(t.name)+1;return this.renderHandle(t,e,r,this.model.length>1)})}trackSegments(){const t=this.model.map(e=>e.normalizedValue);return t.sort((e,r)=>e-r),t.unshift(0),t.map((e,r,o)=>{var s;return[e,(s=o[r+1])!=null?s:1]})}updateModel(){const t=[...this.handles.values()],e=o=>{const s=t[o],i=t[o-1],c=t[o+1],n=typeof s.min=="number"?s.min:this.host.min,u=typeof s.max=="number"?s.max:this.host.max,m={range:{min:n,max:u},clamp:{min:n,max:u}};if(s.min==="previous"&&i){for(let b=o-1;b>=0;b--){const p=t[b];if(typeof p.min=="number"){m.range.min=p.min;break}}m.clamp.min=Math.max(i.value,m.range.min)}if(s.max==="next"&&c){for(let b=o+1;b<t.length;b++){const p=t[b];if(typeof p.max=="number"){m.range.max=p.max;break}}m.clamp.max=Math.min(c.value,m.range.max)}return m},r=t.map((o,s)=>{var i;const c=e(s),{toNormalized:n}=o.normalization,u=Math.max(Math.min(o.value,c.clamp.max),c.clamp.min),m=n(u,c.range.min,c.range.max);return{name:o.handleName,value:u,normalizedValue:m,highlight:o.highlight,step:(i=o.step)!=null?i:this.host.step,normalization:o.normalization,handle:o,ariaLabel:o!==this.host&&(o==null?void 0:o.label.length)>0?o.label:void 0,...c}});this.model=r}async handleUpdatesComplete(){const t=[...this.handles.values()].filter(e=>e!==this.host).map(e=>e.updateComplete);await Promise.all(t)}}const xt=["",()=>{}];class Mc extends _a{constructor(){super(...arguments),this.start=xt,this.streamInside=xt,this.end=xt,this.streamOutside=xt,this.state="off",this.handleStart=t=>{this.callHandler(this.start[1],t),!t.defaultPrevented&&(this.removeListeners(),this.addListeners("on"))},this.handleStream=t=>{this.callHandler(this.streamInside[1],t)},this.handleEnd=t=>{this.callHandler(this.end[1],t),this.removeListeners(),this.addListeners("off")},this.handleBetween=t=>{this.callHandler(this.streamOutside[1],t)}}render(t){return z}update(t,[{start:e,end:r,streamInside:o=xt,streamOutside:s=xt}]){var i;this.element!==t.element&&(this.element=t.element,this.removeListeners()),this.host=((i=t.options)==null?void 0:i.host)||this.element,this.start=e,this.end=r,this.streamInside=o,this.streamOutside=s,this.addListeners()}addListeners(t){this.state=t||this.state,this.state==="off"?(this.addListener(this.streamOutside[0],this.handleBetween),this.addListener(this.start[0],this.handleStart)):this.state==="on"&&(this.addListener(this.streamInside[0],this.handleStream),this.addListener(this.end[0],this.handleEnd))}callHandler(t,e){typeof t=="function"?t.call(this.host,e):t.handleEvent(e)}addListener(t,e){Array.isArray(t)?t.map(r=>{this.element.addEventListener(r,e)}):this.element.addEventListener(t,e)}removeListener(t,e){Array.isArray(t)?t.map(r=>{this.element.removeEventListener(r,e)}):this.element.removeEventListener(t,e)}removeListeners(){this.removeListener(this.start[0],this.handleStart),this.removeListener(this.streamInside[0],this.handleStream),this.removeListener(this.end[0],this.handleEnd),this.removeListener(this.streamOutside[0],this.handleBetween)}disconnected(){this.removeListeners()}reconnected(){this.addListeners()}}const Dc=At(Mc);var qc=Object.defineProperty,Bc=Object.getOwnPropertyDescriptor,O=(a,t,e,r)=>{for(var o=r>1?void 0:r?Bc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&qc(t,e,o),o};const Hc=["filled","ramp","range","tick"];class T extends so(F,""){constructor(){super(...arguments),this.handleController=new Fc(this),this._editable=!1,this.hideStepper=!1,this.type="",this._variant="",this.getAriaValueText=t=>{const e=[...t.values()];return e.length===2?`${e[0]}${this._forcedUnit} - ${e[1]}${this._forcedUnit}`:e.join(`${this._forcedUnit}, `)+this._forcedUnit},this.min=0,this.max=100,this.step=1,this.tickStep=0,this.tickLabels=!1,this.disabled=!1,this.quiet=!1,this.indeterminate=!1,this._numberFieldInput=Promise.resolve()}static get styles(){return[Lc]}get editable(){return this._editable}set editable(t){if(t===this.editable)return;const e=this.editable;this._editable=this.handleController.size<2?t:!1,this.editable&&(this._numberFieldInput=tr(()=>import("./sp-number-field-be4fe029.js"),[],import.meta.url)),e!==this.editable&&this.requestUpdate("editable",e)}set variant(t){const e=this.variant;t!==this.variant&&(Hc.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e))}get variant(){return this._variant}get values(){return this.handleController.values}get handleName(){return"value"}get ariaValueText(){return this.getAriaValueText?this.getAriaValueText(this.handleController.formattedValues):`${this.value}${this._forcedUnit}`}get numberFormat(){return this.getNumberFormat()}get focusElement(){return this.handleController.focusElement}handleLabelClick(t){this.editable&&(t.preventDefault(),this.focus())}render(){return d`
            ...
            ${this.editable?d`
                      ...
                      ></sp-number-field>
                  `:d``}
        `}connectedCallback(){super.connectedCallback(),this.handleController.hostConnected()}disconnectedCallback(){super.disconnectedCallback(),this.handleController.hostDisconnected()}update(t){this.handleController.hostUpdate(),t.has("disabled")&&this.disabled&&this.handleController.cancelDrag(),super.update(t)}renderLabel(){const t=this.labelVisibility==="none"||this.labelVisibility==="value",e=this.labelVisibility==="none"||this.labelVisibility==="text";return d`
        ...
        `}renderRamp(){return this.variant!=="ramp"?d``:d`
            <div id="ramp">
                <svg
                    viewBox="0 0 240 16"
        ...
        `}renderTicks(){if(this.variant!=="tick")return d``;const t=this.tickStep||this.step,e=(this.max-this.min)/t,r=e%1!==0,o=new Array(Math.floor(e+1));return o.fill(0,0,e+1),d`
            <div
                class="${r?"not-exact ":""}ticks"
                style=${C(r?`--sp-slider-tick-offset: calc(100% / ${this.max} * ${this.tickStep}`:void 0)}
            >
                ${o.map((s,i)=>d`
                        <div class="tick">
                            ${this.tickLabels?d`
        ...
        `}renderTrackSegment(t,e){return this.variant==="ramp"?d``:d`
            <div
                class="track"
                style=${Qe(this.trackSegmentStyles(t,e))}
                role="presentation"
            ></div>
        `}renderTrack(){const t=this.handleController.trackSegments(),e=[{id:"track0",html:this.renderTrackSegment(...t[0])},{id:"ramp",html:this.renderRamp()},{id:"ticks",html:this.renderTicks()},{id:"handles",html:this.handleController.render()},...t.slice(1).map(([r,o],s)=>({id:`track${s+1}`,html:this.renderTrackSegment(r,o)}))];return d`
            <div
                id="track"
                ${Dc({start:["pointerdown",this.handlePointerdown],streamInside:["pointermove",this.handlePointermove],end:[["pointerup","pointercancel"],this.handlePointerup]})}
            >
                <div id="controls">
                    ${He(e,r=>r.id,r=>r.html)}
                </div>
            </div>
        `}handlePointerdown(t){this.handleController.handlePointerdown(t)}handlePointermove(t){this.handleController.handlePointermove(t)}handlePointerup(t){this.handleController.handlePointerup(t)}handleNumberInput(t){var e;const{value:r}=t.target;if((e=t.target)!=null&&e.managedInput&&!isNaN(r)){this.value=r;return}t.stopPropagation()}handleNumberChange(t){var e;const{value:r}=t.target;isNaN(r)?(t.target.value=this.value,t.stopPropagation()):(this.value=r,(e=t.target)!=null&&e.managedInput||this.dispatchInputEvent()),this.indeterminate=!1}trackSegmentStyles(t,e){const r=e-t;return{width:`${r*100}%`,"--spectrum-slider-track-background-size":`${1/r*100}%`,"--spectrum-slider-track-segment-position":`${t*100}%`}}async getUpdateComplete(){const t=await super.getUpdateComplete();return this.editable&&(await this._numberFieldInput,await this.numberField.updateComplete),await this.handleController.handleUpdatesComplete(),t}}O([l({type:Boolean,reflect:!0})],T.prototype,"editable",1),O([l({type:Boolean,reflect:!0,attribute:"hide-stepper"})],T.prototype,"hideStepper",2),O([l()],T.prototype,"type",2),O([l({type:String})],T.prototype,"variant",1),O([l({attribute:!1})],T.prototype,"getAriaValueText",2),O([l({type:String,reflect:!0,attribute:"label-visibility"})],T.prototype,"labelVisibility",2),O([l({type:Number,reflect:!0})],T.prototype,"min",2),O([l({type:Number,reflect:!0})],T.prototype,"max",2),O([l({type:Number})],T.prototype,"step",2),O([l({type:Number,attribute:"tick-step"})],T.prototype,"tickStep",2),O([l({type:Boolean,attribute:"tick-labels"})],T.prototype,"tickLabels",2),O([l({type:Boolean,reflect:!0})],T.prototype,"disabled",2),O([l({type:Boolean})],T.prototype,"quiet",2),O([l({type:Boolean})],T.prototype,"indeterminate",2),O([W("#label")],T.prototype,"labelEl",2),O([W("#number-field")],T.prototype,"numberField",2),O([W("#track")],T.prototype,"track",2);customElements.define("sp-slider",T);var Uc=Object.defineProperty,Rc=Object.getOwnPropertyDescriptor,zo=(a,t,e,r)=>{for(var o=r>1?void 0:r?Rc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Uc(t,e,o),o};class ge extends j{constructor(){super(...arguments),this.fullscreenMode=!1,this.zoom=1}handleZoomSliderChange(){var r;const e=((r=this.shadowRoot)==null?void 0:r.getElementById("zoom-slider")).value;x(this,"set-zoom-centered-on-canvas",{value:e})}handleFullscreenToggle(){x(this,"set-fullscreen-mode",{value:!this.fullscreenMode})}render(){return d`
      <div class="slider-panel ${this.fullscreenMode?"hidden":""}">
        <sp-slider id="zoom-slider" @input=${this.handleZoomSliderChange} label-visibility="none" label="Zoom" min=0.1 max=2 step=0.05 value=${this.zoom.toFixed(2)}></sp-slider>
      </div>
      <div class="button-panel">
        ...
        ><i class=${this.fullscreenMode?"exit-fullscreen":"enter-fullscreen"} slot="icon"></i></sp-action-button>
      </div>
    `}}ge.styles=v`
  ...
  `;zo([l({type:Boolean})],ge.prototype,"fullscreenMode",2);zo([l({type:Number})],ge.prototype,"zoom",2);customElements.define("stvt-hud",ge);var Gc=Object.defineProperty,Kc=Object.getOwnPropertyDescriptor,Xt=(a,t,e,r)=>{for(var o=r>1?void 0:r?Kc(t,e):t,s=a.length-1,i;s>=0;s--)(i=a[s])&&(o=(r?i(t,e,o):i(o))||o);return r&&o&&Gc(t,e,o),o};class ht extends j{constructor(){super(),this.graphState=R.DEFAULT_STATE,this.appState=_t.DEFAULT_STATE,this.dictionary=[],this.showAlert=!1,this.alertMessage="Alert!",this.alertKey="",this.urlParamComponent="",this.urlParamToken="",this.urlParamFilter="",this.urlParams=new URLSearchParams(window.location.search),this.urlParamComponent=this.urlParams.get("component")||"",this.urlParamToken=this.urlParams.get("token")||"",this.urlParamFilter=this.urlParams.get("filter")||"",this.graphController=new Xo;const t=this.urlParamToken.split(","),e=this.urlParamComponent.split(","),r=this.urlParamFilter.split(",");t.length===1&&t[0]===""&&t.pop(),e.length===1&&e[0]===""&&e.pop(),r.length===1&&r[0]===""&&r.pop(),this.urlParams.has("filter")||r.push("spectrum","light","desktop"),this.appController=new Qo({graphController:this.graphController,selectedComponents:e,selectedTokens:t,setFilters:r}),this.graphController.onDictionaryAvailable(o=>this.dictionary=o),this.graphController.onNewGraphState(o=>this.graphState=o),this.appController.onNewAppState(o=>{this.appState=o}),this.graphState=this.graphController.displayGraphModel.state,this.appState=this.appController.appModel.state,window.addEventListener("popstate",()=>{this.urlParams=new URLSearchParams(window.location.search),this.urlParamComponent=this.urlParams.get("component")||"",this.urlParamToken=this.urlParams.get("token")||"",this.urlParamFilter=this.urlParams.get("filter")||"";const o=this.urlParamToken.split(","),s=this.urlParamComponent.split(","),i=this.urlParamFilter.split(",");o.length===1&&o[0]===""&&o.pop(),s.length===1&&s[0]===""&&s.pop(),i.length===1&&i[0]===""&&i.pop(),this.appController.appModel.setSelectedComponents(s),this.appController.appModel.setSelectedTokens(o),this.appController.appModel.setSetFilters(i),this.appController.emitNewAppState()},!1),window.addEventListener("keydown",o=>{var s,i,c;switch(o.code){case"KeyZ":this.appController.handleEvent("set-zoom-centered-on-canvas",{value:this.appState.zoom*(o.shiftKey?.8:1.2)});break;case"ArrowUp":this.appController.handleEvent("set-panning-position",{x:this.appState.panX,y:this.appState.panY+30*(o.shiftKey?10:1)});break;case"ArrowDown":this.appController.handleEvent("set-panning-position",{x:this.appState.panX,y:this.appState.panY-30*(o.shiftKey?10:1)});break;case"ArrowLeft":this.appController.handleEvent("set-panning-position",{x:this.appState.panX+30*(o.shiftKey?10:1),y:this.appState.panY});break;case"ArrowRight":this.appController.handleEvent("set-panning-position",{x:this.appState.panX-30*(o.shiftKey?10:1),y:this.appState.panY});break;case"KeyF":if(o.metaKey||o.ctrlKey){o.preventDefault();try{const m=(c=((i=((s=this.shadowRoot)==null?void 0:s.getElementById("stvt-sidebar")).shadowRoot)==null?void 0:i.getElementById("stvt-search")).shadowRoot)==null?void 0:c.getElementById("search");m==null||m.focus()}catch{console.info("failed to traverse shadow dom looking for search input to focus")}}break}})}willUpdate(t){if(t.has("appState")){let e=!1;const r=this.appState.selectedComponents.join(","),o=this.appState.selectedTokens.join(","),s=this.appState.setFilters.join(",");r!==this.urlParamComponent&&(this.urlParamComponent=r,r===""?this.urlParams.delete("component"):this.urlParams.set("component",r),e=!0),o!==this.urlParamToken&&(this.urlParamToken=o,o===""?this.urlParams.delete("token"):this.urlParams.set("token",o),e=!0),s!==this.urlParamFilter&&(this.urlParamFilter=s,s===""?this.urlParams.set("filter",s):this.urlParams.set("filter",s),e=!0),e&&window.history.pushState({},"",`${location.pathname}?${this.urlParams}`)}}async handleCopiedToClipboard(t){this.showAlert=!0;const e=t.detail.id;this.alertMessage=`${e} copied to clipboard.`,this.alertKey=e,setTimeout(()=>{this.alertKey===e&&(this.showAlert=!1)},2500)}render(){return d`
      <sp-theme scale="medium" color=${this.appState.spectrumColorTheme} class=${this.appState.fullscreenMode?"fullscreen-mode":""}>
        <stvt-sidebar
          id="stvt-sidebar"
          @gesturechange=${t=>t.preventDefault()}
          @gesturestart=${t=>t.preventDefault()}
          @gestureend=${t=>t.preventDefault()}
          @set-spectrum-color-theme=${t=>this.appController.handleEvent("set-spectrum-color-theme",t.detail)}
          @filters-selected=${t=>this.appController.handleEvent("filters-selected",t.detail)}
          @select-id=${t=>this.appController.handleEvent("select-id",t.detail)}
          .dictionary=${this.dictionary}
        ...
        <stvt-tabs
          ...
          @gesturestart=${t=>t.preventDefault()}
          @gestureend=${t=>t.preventDefault()}
          @close-tab=${t=>this.appController.handleEvent("close-tab",t.detail)}
          @close-all-tabs=${t=>this.appController.handleEvent("close-all-tabs",t.detail)}
          .dictionary=${this.dictionary}
          .selectedTokens=${this.appState.selectedTokens}
          .selectedComponents=${this.appState.selectedComponents}
        ></stvt-tabs>
        <token-graph
          @set-zoom=${t=>this.appController.handleEvent("set-zoom",t.detail)}
          @set-panning-position=${t=>this.appController.handleEvent("set-panning-position",t.detail)}
          @panning-input-delta=${t=>this.appController.handleEvent("panning-input-delta",t.detail)}
          @node-click=${t=>this.appController.handleEvent("node-click",t.detail)}
          @node-dragmove=${t=>this.graphController.handleEvent("node-dragmove",t.detail)}
          @node-pointerover=${t=>this.appController.handleEvent("node-pointerover",t.detail)}
          @node-pointerout=${t=>this.appController.handleEvent("node-pointerout",t.detail)}
          @node-dragstart=${t=>this.appController.handleEvent("node-dragstart",t.detail)}
          @node-dragend=${t=>this.appController.handleEvent("node-dragend",t.detail)}
          @generic-gesture-start=${t=>this.appController.handleEvent("generic-gesture-start",t.detail)}
          @generic-gesture-end=${t=>this.appController.handleEvent("generic-gesture-end",t.detail)}
          @copied-to-clipboard=${this.handleCopiedToClipboard}
          .graphState=${this.graphState}
          .appState=${this.appState}
        ></token-graph>
        <stvt-hud
          @set-zoom-centered-on-canvas=${t=>this.appController.handleEvent("set-zoom-centered-on-canvas",t.detail)}
          @set-fullscreen-mode=${t=>this.appController.handleEvent("set-fullscreen-mode",t.detail)}
  ...
  `;Xt([l({type:Object})],ht.prototype,"graphState",2);Xt([l({type:Object})],ht.prototype,"appState",2);Xt([l({type:Object})],ht.prototype,"dictionary",2);Xt([l({type:Boolean})],ht.prototype,"showAlert",2);Xt([l({type:String})],ht.prototype,"alertMessage",2);customElements.define("stvt-app",ht);export{Pr as $,q as I,zc as L,ot as S,E as T,Ua as a,il as b,Dc as c,Ka as d,W as e,l as f,Fa as g,C as h,v as i,xo as l,mt as s,pt as t,d as y};
